...
fn external_agent_cli_modes_fixture_documents_all_public_modes() {
    ...
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-admission-smoke",
        "policy_reuse_evidence_retrieval_result_admission_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-admission-regression-smoke",
        "policy_reuse_evidence_retrieval_result_admission_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-manifest-smoke",
        "policy_reuse_evidence_retrieval_result_manifest_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-manifest-regression-smoke",
        "policy_reuse_evidence_retrieval_result_manifest_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-admission-smoke",
        "policy_reuse_evidence_retrieval_result_use_admission_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-admission-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_admission_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-manifest-smoke",
        "policy_reuse_evidence_retrieval_result_use_manifest_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-manifest-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_manifest_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-readiness-smoke",
        "policy_reuse_evidence_retrieval_result_use_readiness_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-readiness-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_readiness_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-approval-smoke",
        "policy_reuse_evidence_retrieval_result_use_approval_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-approval-regression-smoke",
    ...
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-admission-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-admission-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-readiness-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-readiness-regression-smoke",
    ...
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-eligibility-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-eligibility-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-admission-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-admission-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-materialization-plan-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-materialization-plan-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-admission-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-admission-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-commit-intent-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-commit-intent-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-write-preflight-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_smoke",
    ));
    assert!(catalog.contains(
    ...
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-write-admission-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-write-admission-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_regression_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-write-commit-intent-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_smoke",
    ));
    assert!(catalog.contains(
        "root_validate --policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-learning-storage-write-commit-intent-regression-smoke",
        "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_regression_smoke",
    ));
    assert!(catalog.contains(
...
fn root_validate_policy_reuse_performance_cost_trend_smoke_mode_is_executable_contract() {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"avoided_llm_calls_per_batch\":4",
            "\"reuse_rate_bps\":6666",
            "\"validation_expected_count_guarded_tests\":274",
            "\"estimated_ms_per_guarded_test\":10",
            "\"runtime_budget_status\":\"pass\"",
            "\"validation_cost_verdict\":\"pass\"",
...
fn root_validate_policy_reuse_performance_cost_trend_regression_smoke_mode_is_executable_contract()
{
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"reuse_rate_bps\":6666",
            "\"validation_expected_count_guarded_tests\":274",
            "\"estimated_ms_per_guarded_test\":12",
            "\"runtime_budget_status\":\"pass\"",
            "\"validation_cost_verdict\":\"fail\"",
...
#[test]
fn policy_reuse_evidence_retrieval_result_admission_smoke_composes_result_admission() {
    let receipt =
        ai::validation_harness::policy_reuse_evidence_retrieval_result_admission_smoke_receipt();
    let query_approval =
        ai::validation_harness::policy_reuse_evidence_retrieval_query_approval_smoke_receipt();
    let query_plan =
        ai::validation_harness::policy_reuse_evidence_retrieval_query_plan_smoke_receipt();
    ...
    assert_eq!(
        receipt.schema,
        "canon_policy_reuse_evidence_retrieval_result_admission_v1"
    );
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_ADMISSION_SMOKE_STEP
    );
    assert_eq!(receipt.retrieval_result_admission_version, 1);
    assert_eq!(
        receipt.source_retrieval_query_approval_hash,
        query_approval.receipt_hash
    );
    assert_eq!(
        receipt.source_retrieval_query_plan_hash,
        query_plan.receipt_hash
    ...
    assert_eq!(
        receipt.admitted_result_policy_reuse_examples,
        query_approval.approved_query_policy_reuse_examples
    );
    assert_eq!(
        receipt.admitted_result_llm_fallback_examples,
        query_approval.approved_query_llm_fallback_examples
    );
    assert!(receipt.retrieval_result_admitted);
    assert_eq!(receipt.result_admission_status, "result_admitted");
    assert_eq!(receipt.not_admitted_reason, "none");
    assert_ne!(receipt.result_admission_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_admission_regression_smoke_is_valid_not_admitted_evidence(
) {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_admission_regression_smoke_receipt();
    let query_approval = ai::validation_harness::
        policy_reuse_evidence_retrieval_query_approval_regression_smoke_receipt();
    let query_plan =
        ai::validation_harness::policy_reuse_evidence_retrieval_query_plan_regression_smoke_receipt(
        );
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_ADMISSION_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_query_approval_hash,
        query_approval.receipt_hash
    ...
    assert!(!receipt.retrieval_result_admitted);
    assert_eq!(receipt.result_admission_status, "result_not_admitted");
    assert_eq!(receipt.not_admitted_reason, "query_not_approved");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_admission_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-admission-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_admission_smoke\"",
            ...
            "\"retrieval_result_admitted\":true",
            "\"result_admission_status\":\"result_admitted\"",
            "\"not_admitted_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_admission_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-admission-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_admission_regression_smoke\"",
            "\"retrieval_result_admission_version\":1",
            "\"retrieval_query_approved\":false",
            "\"retrieval_query_plan_ready\":false",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_admitted\":false",
            "\"result_admission_status\":\"result_not_admitted\"",
            "\"not_admitted_reason\":\"query_not_approved\"",
            "\"result_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_manifest_smoke_summarizes_admitted_result() {
    let receipt =
        ai::validation_harness::policy_reuse_evidence_retrieval_result_manifest_smoke_receipt();
    ...
    assert_eq!(
        receipt.schema,
        "canon_policy_reuse_evidence_retrieval_result_manifest_v1"
    );
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_MANIFEST_SMOKE_STEP
    );
    assert_eq!(receipt.retrieval_result_manifest_version, 1);
    assert_eq!(
        receipt.source_retrieval_result_admission_hash,
    ...
    assert_eq!(
        receipt.manifest_policy_reuse_examples,
        result_admission.admitted_result_policy_reuse_examples
    );
    assert_eq!(
        receipt.manifest_llm_fallback_examples,
        result_admission.admitted_result_llm_fallback_examples
    );
    assert!(receipt.retrieval_result_manifest_ready);
    assert_eq!(receipt.result_manifest_status, "result_manifest_ready");
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.result_manifest_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_manifest_regression_smoke_is_valid_not_ready_evidence() {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_manifest_regression_smoke_receipt();
    let result_admission = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_admission_regression_smoke_receipt();
    let query_approval = ai::validation_harness::
        policy_reuse_evidence_retrieval_query_approval_regression_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_MANIFEST_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_admission_hash,
        result_admission.receipt_hash
    ...
    assert!(!receipt.retrieval_result_manifest_ready);
    assert_eq!(receipt.result_manifest_status, "result_manifest_not_ready");
    assert_eq!(receipt.not_ready_reason, "result_not_admitted");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_manifest_smoke_mode_is_executable_contract()
{
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-manifest-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_manifest_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_manifest_smoke\"",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_manifest_ready\":true",
            "\"result_manifest_status\":\"result_manifest_ready\"",
            "\"not_ready_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_manifest_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-manifest-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_manifest_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_manifest_regression_smoke\"",
            "\"retrieval_result_manifest_version\":1",
            "\"retrieval_result_admitted\":false",
            "\"retrieval_query_approved\":false",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_manifest_ready\":false",
            "\"result_manifest_status\":\"result_manifest_not_ready\"",
            "\"not_ready_reason\":\"result_not_admitted\"",
            "\"result_manifest_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_admission_smoke_admits_ready_manifest() {
    let receipt =
        ai::validation_harness::policy_reuse_evidence_retrieval_result_use_admission_smoke_receipt(
        );
    let result_manifest =
        ai::validation_harness::policy_reuse_evidence_retrieval_result_manifest_smoke_receipt();
    let result_admission =
    ...
    assert_eq!(
        receipt.schema,
        "canon_policy_reuse_evidence_retrieval_result_use_admission_v1"
    );
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_ADMISSION_SMOKE_STEP
    );
    assert_eq!(receipt.retrieval_result_use_admission_version, 1);
    assert_eq!(
        receipt.source_retrieval_result_manifest_hash,
        result_manifest.receipt_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_admission_hash,
        result_admission.receipt_hash
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.admitted_use_policy_reuse_examples,
        result_manifest.manifest_policy_reuse_examples
    );
    assert_eq!(
        receipt.admitted_use_llm_fallback_examples,
        result_manifest.manifest_llm_fallback_examples
    );
    assert!(receipt.retrieval_result_use_admitted);
    assert_eq!(receipt.result_use_admission_status, "result_use_admitted");
    assert_eq!(receipt.not_admitted_reason, "none");
    assert_ne!(receipt.result_use_admission_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_admission_regression_smoke_is_valid_not_admitted_evidence(
) {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_admission_regression_smoke_receipt();
    let result_manifest = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_manifest_regression_smoke_receipt();
    let result_admission = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_admission_regression_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_ADMISSION_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_manifest_hash,
        result_manifest.receipt_hash
    ...
    assert!(!receipt.retrieval_result_use_admitted);
    assert_eq!(
        receipt.result_use_admission_status,
        "result_use_not_admitted"
    );
    assert_eq!(receipt.not_admitted_reason, "manifest_not_ready");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_admission_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_admission_smoke\"",
            "\"retrieval_result_use_admission_version\":1",
            "\"source_retrieval_result_manifest_hash\":",
            "\"source_retrieval_result_admission_hash\":",
            "\"retrieval_result_manifest_ready\":true",
            "\"retrieval_result_admitted\":true",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_admitted\":true",
            "\"result_use_admission_status\":\"result_use_admitted\"",
            "\"not_admitted_reason\":\"none\"",
            "\"result_use_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_admission_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-admission-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_admission_regression_smoke\"",
            "\"retrieval_result_use_admission_version\":1",
            "\"retrieval_result_manifest_ready\":false",
            "\"retrieval_result_admitted\":false",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_admitted\":false",
            "\"result_use_admission_status\":\"result_use_not_admitted\"",
            "\"not_admitted_reason\":\"manifest_not_ready\"",
            "\"result_use_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_manifest_smoke_summarizes_admitted_use() {
    let receipt =
        ai::validation_harness::policy_reuse_evidence_retrieval_result_use_manifest_smoke_receipt();
    ...
    assert_eq!(
        receipt.schema,
        "canon_policy_reuse_evidence_retrieval_result_use_manifest_v1"
    );
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_MANIFEST_SMOKE_STEP
    );
    assert_eq!(receipt.retrieval_result_use_manifest_version, 1);
    assert_eq!(
        receipt.source_retrieval_result_use_admission_hash,
        result_use_admission.receipt_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_manifest_hash,
        result_manifest.receipt_hash
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.use_manifest_policy_reuse_examples,
        result_use_admission.admitted_use_policy_reuse_examples
    );
    assert_eq!(
        receipt.use_manifest_llm_fallback_examples,
        result_use_admission.admitted_use_llm_fallback_examples
    );
    assert!(receipt.retrieval_result_use_manifest_ready);
    assert_eq!(
        receipt.result_use_manifest_status,
        "result_use_manifest_ready"
    );
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.result_use_manifest_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_manifest_regression_smoke_is_valid_not_ready_evidence(
) {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_manifest_regression_smoke_receipt();
    let result_use_admission = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_admission_regression_smoke_receipt();
    let result_manifest = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_manifest_regression_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_MANIFEST_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_admission_hash,
        result_use_admission.receipt_hash
    ...
    assert_eq!(receipt.not_ready_reason, "use_not_admitted");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_manifest_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-manifest-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_manifest_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_manifest_smoke\"",
            "\"retrieval_result_use_manifest_version\":1",
            "\"source_retrieval_result_use_admission_hash\":",
            "\"source_retrieval_result_manifest_hash\":",
            "\"retrieval_result_use_admitted\":true",
            "\"retrieval_result_manifest_ready\":true",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_manifest_ready\":true",
            "\"result_use_manifest_status\":\"result_use_manifest_ready\"",
            "\"not_ready_reason\":\"none\"",
            "\"result_use_manifest_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_manifest_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-manifest-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_manifest_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_manifest_regression_smoke\"",
            "\"retrieval_result_use_manifest_version\":1",
            "\"retrieval_result_use_admitted\":false",
            "\"retrieval_result_manifest_ready\":false",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_manifest_ready\":false",
            "\"result_use_manifest_status\":\"result_use_manifest_not_ready\"",
            "\"not_ready_reason\":\"use_not_admitted\"",
            "\"result_use_manifest_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_readiness_smoke_summarizes_ready_manifest() {
    let receipt =
    ...
    assert_eq!(
        receipt.schema,
        "canon_policy_reuse_evidence_retrieval_result_use_readiness_v1"
    );
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_READINESS_SMOKE_STEP
    );
    assert_eq!(receipt.retrieval_result_use_readiness_version, 1);
    assert_eq!(
        receipt.source_retrieval_result_use_manifest_hash,
        result_use_manifest.receipt_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_admission_hash,
        result_use_admission.receipt_hash
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.readiness_policy_reuse_examples,
        result_use_manifest.use_manifest_policy_reuse_examples
    );
    assert_eq!(
        receipt.readiness_llm_fallback_examples,
        result_use_manifest.use_manifest_llm_fallback_examples
    );
    assert!(receipt.retrieval_result_use_ready);
    assert_eq!(receipt.result_use_readiness_status, "result_use_ready");
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.result_use_readiness_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_readiness_regression_smoke_is_valid_not_ready_evidence(
) {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_readiness_regression_smoke_receipt();
    let result_use_manifest = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_manifest_regression_smoke_receipt();
    let result_use_admission = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_admission_regression_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_READINESS_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_manifest_hash,
        result_use_manifest.receipt_hash
    ...
    assert!(!receipt.retrieval_result_use_ready);
    assert_eq!(receipt.result_use_readiness_status, "result_use_not_ready");
    assert_eq!(receipt.not_ready_reason, "manifest_not_ready");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_readiness_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-readiness-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_readiness_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_readiness_smoke\"",
            "\"retrieval_result_use_readiness_version\":1",
            "\"source_retrieval_result_use_manifest_hash\":",
            "\"source_retrieval_result_use_admission_hash\":",
            "\"retrieval_result_use_manifest_ready\":true",
            "\"retrieval_result_use_admitted\":true",
            "\"retrieval_read_performed\":false",
            ...
            "\"result_use_readiness_status\":\"result_use_ready\"",
            "\"not_ready_reason\":\"none\"",
            "\"result_use_readiness_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_readiness_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-readiness-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_readiness_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_readiness_regression_smoke\"",
            "\"retrieval_result_use_readiness_version\":1",
            "\"retrieval_result_use_manifest_ready\":false",
            "\"retrieval_result_use_admitted\":false",
            "\"retrieval_read_performed\":false",
            ...
            "\"result_use_readiness_status\":\"result_use_not_ready\"",
            "\"not_ready_reason\":\"manifest_not_ready\"",
            "\"result_use_readiness_hash\":",
            "\"receipt_hash\":",
        ],
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_approval_smoke_approves_ready_use() {
    let receipt =
    ...
    assert_eq!(
        receipt.schema,
        "canon_policy_reuse_evidence_retrieval_result_use_approval_v1"
    );
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_APPROVAL_SMOKE_STEP
    );
    assert_eq!(receipt.retrieval_result_use_approval_version, 1);
    assert_eq!(
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.approved_use_policy_reuse_examples,
        result_use_readiness.readiness_policy_reuse_examples
    );
    assert_eq!(
        receipt.approved_use_llm_fallback_examples,
        result_use_readiness.readiness_llm_fallback_examples
    );
    assert!(receipt.retrieval_result_use_approved);
    assert_eq!(receipt.result_use_approval_status, "result_use_approved");
    assert_eq!(receipt.not_approved_reason, "none");
    assert_ne!(receipt.result_use_approval_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_approval_regression_smoke_is_valid_not_approved_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_APPROVAL_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_readiness_hash,
        result_use_readiness.receipt_hash
    ...
    assert!(!receipt.retrieval_result_use_approved);
    assert_eq!(
        receipt.result_use_approval_status,
        "result_use_not_approved"
    );
    assert_eq!(receipt.not_approved_reason, "readiness_not_ready");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_approval_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-approval-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_approval_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_approval_smoke\"",
            ...
            "\"result_use_approval_status\":\"result_use_approved\"",
            "\"not_approved_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_approval_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-approval-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_approval_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_approval_regression_smoke\"",
            "\"retrieval_result_use_approval_version\":1",
            "\"retrieval_result_use_ready\":false",
            "\"retrieval_result_use_manifest_ready\":false",
            "\"retrieval_read_performed\":false",
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_smoke_summarizes_admitted_use() {
    let receipt =
        ai::validation_harness::policy_reuse_evidence_retrieval_result_use_summary_smoke_receipt();
    let manifest_admission = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_manifest_admission_smoke_receipt();
    let result_use_approval =
        ai::validation_harness::policy_reuse_evidence_retrieval_result_use_approval_smoke_receipt();
    ...
    assert_eq!(
        receipt.schema,
        "canon_policy_reuse_evidence_retrieval_result_use_summary_v1"
    );
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_SMOKE_STEP
    );
    assert_eq!(receipt.retrieval_result_use_summary_version, 1);
    assert_eq!(
        receipt.source_retrieval_result_use_manifest_admission_hash,
        manifest_admission.receipt_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_approval_hash,
        result_use_approval.receipt_hash
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.summary_policy_reuse_examples,
        manifest_admission.manifest_admission_policy_reuse_examples
    );
    assert_eq!(
        receipt.summary_llm_fallback_examples,
        manifest_admission.manifest_admission_llm_fallback_examples
    );
    assert!(receipt.retrieval_result_use_summary_ready);
    assert_eq!(
        receipt.result_use_summary_status,
        "result_use_summary_ready"
    );
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.result_use_summary_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_regression_smoke_is_valid_not_ready_evidence()
{
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_manifest_admission_hash,
        manifest_admission.receipt_hash
    ...
    assert_eq!(receipt.not_ready_reason, "manifest_not_admitted");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_smoke\"",
            "\"retrieval_result_use_summary_version\":1",
            "\"source_retrieval_result_use_manifest_admission_hash\":",
            "\"source_retrieval_result_use_approval_hash\":",
            "\"retrieval_result_use_manifest_admitted\":true",
            "\"retrieval_result_use_approved\":true",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_summary_ready\":true",
            "\"result_use_summary_status\":\"result_use_summary_ready\"",
            "\"not_ready_reason\":\"none\"",
            "\"result_use_summary_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-summary-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_regression_smoke\"",
            "\"retrieval_result_use_summary_version\":1",
            "\"retrieval_result_use_manifest_admitted\":false",
            "\"retrieval_result_use_approved\":false",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_summary_ready\":false",
            "\"result_use_summary_status\":\"result_use_summary_not_ready\"",
            "\"not_ready_reason\":\"manifest_not_admitted\"",
            "\"result_use_summary_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_smoke_packages_summary() {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.schema,
        "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_v1"
    );
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_SMOKE_STEP
    );
    assert_eq!(receipt.retrieval_result_use_summary_manifest_version, 1);
    assert_eq!(
        receipt.source_retrieval_result_use_summary_hash,
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.summary_manifest_policy_reuse_examples,
        summary.summary_policy_reuse_examples
    );
    assert_eq!(
        receipt.summary_manifest_llm_fallback_examples,
        summary.summary_llm_fallback_examples
    );
    assert!(receipt.retrieval_result_use_summary_manifest_ready);
    assert_eq!(
        receipt.result_use_summary_manifest_status,
        "result_use_summary_manifest_ready"
    );
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.result_use_summary_manifest_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_regression_smoke_is_valid_not_ready_evidence(
) {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_regression_smoke_receipt();
    let summary = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_regression_smoke_receipt();
    let manifest_admission = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_manifest_admission_regression_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_hash,
        summary.receipt_hash
    ...
    assert_eq!(receipt.not_ready_reason, "summary_not_ready");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-summary-manifest-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_smoke\"",
            "\"retrieval_result_use_summary_manifest_version\":1",
            "\"source_retrieval_result_use_summary_hash\":",
            "\"source_retrieval_result_use_manifest_admission_hash\":",
            "\"retrieval_result_use_summary_ready\":true",
            "\"retrieval_result_use_manifest_admitted\":true",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_summary_manifest_ready\":true",
            "\"result_use_summary_manifest_status\":\"result_use_summary_manifest_ready\"",
            "\"not_ready_reason\":\"none\"",
            "\"result_use_summary_manifest_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-summary-manifest-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_regression_smoke\"",
            "\"retrieval_result_use_summary_manifest_version\":1",
            "\"retrieval_result_use_summary_ready\":false",
            "\"retrieval_result_use_manifest_admitted\":false",
            "\"retrieval_read_performed\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_summary_manifest_ready\":false",
            "\"result_use_summary_manifest_status\":\"result_use_summary_manifest_not_ready\"",
            "\"not_ready_reason\":\"summary_not_ready\"",
            "\"result_use_summary_manifest_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke_admits_manifest() {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke_receipt();
    let summary_manifest = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_smoke_receipt();
    let summary =
        ai::validation_harness::policy_reuse_evidence_retrieval_result_use_summary_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_ADMISSION_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_hash,
        summary_manifest.receipt_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_hash,
        summary.receipt_hash
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.summary_manifest_admission_policy_reuse_examples,
        summary_manifest.summary_manifest_policy_reuse_examples
    );
    assert_eq!(
        receipt.summary_manifest_admission_llm_fallback_examples,
    ...
    assert_eq!(receipt.not_admitted_reason, "none");
    assert_ne!(receipt.result_use_summary_manifest_admission_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_regression_smoke_is_valid_not_admitted_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_ADMISSION_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_hash,
        summary_manifest.receipt_hash
    ...
    assert_eq!(receipt.not_admitted_reason, "summary_manifest_not_ready");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-summary-manifest-admission-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke\"",
            ...
            "\"result_use_summary_manifest_admission_status\":\"result_use_summary_manifest_admitted\"",
            "\"not_admitted_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-summary-manifest-admission-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_regression_smoke\"",
            "\"retrieval_result_use_summary_manifest_admission_version\":1",
            "\"retrieval_result_use_summary_manifest_ready\":false",
            "\"retrieval_result_use_summary_ready\":false",
            "\"retrieval_read_performed\":false",
            ...
            "\"result_use_summary_manifest_admission_status\":\"result_use_summary_manifest_not_admitted\"",
            "\"not_admitted_reason\":\"summary_manifest_not_ready\"",
            "\"result_use_summary_manifest_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_smoke_confirms_admitted_manifest(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_READINESS_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.summary_manifest_readiness_policy_reuse_examples,
        admission.summary_manifest_admission_policy_reuse_examples
    );
    assert_eq!(
        receipt.summary_manifest_readiness_llm_fallback_examples,
    ...
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.result_use_summary_manifest_readiness_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_regression_smoke_is_valid_not_ready_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_READINESS_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_admission_hash,
        admission.receipt_hash
    ...
    assert_eq!(receipt.not_ready_reason, "summary_manifest_not_admitted");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_smoke\"",
            ...
            "\"result_use_summary_manifest_readiness_status\":\"result_use_summary_manifest_ready_for_use\"",
            "\"not_ready_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-summary-manifest-readiness-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_regression_smoke\"",
            "\"retrieval_result_use_summary_manifest_readiness_version\":1",
            "\"retrieval_result_use_summary_manifest_admitted\":false",
            "\"retrieval_result_use_summary_manifest_ready\":false",
            "\"retrieval_read_performed\":false",
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke_admits_approved_manifest(
) {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke_receipt();
    let approval = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_smoke_receipt();
    let readiness = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_smoke_receipt();
    let admission = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.summary_manifest_approval_admission_policy_reuse_examples,
        approval.summary_manifest_approval_policy_reuse_examples
    );
    assert_eq!(
        receipt.summary_manifest_approval_admission_llm_fallback_examples,
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_regression_smoke_is_valid_not_admitted_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_hash,
        approval.receipt_hash
    ...
    assert_eq!(receipt.not_admitted_reason, "summary_manifest_not_approved");
    assert!(receipt.is_valid());
    assert!(!receipt.passed());
}

#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke\"",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_summary_manifest_approval_admitted\":true",
            "\"result_use_summary_manifest_approval_admission_status\":\"result_use_summary_manifest_approval_admitted\"",
            "\"not_admitted_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_regression_smoke\"",
            "\"retrieval_result_use_summary_manifest_approval_admission_version\":1",
            "\"retrieval_result_use_summary_manifest_approved\":false",
            "\"retrieval_result_use_summary_manifest_ready_for_use\":false",
            "\"retrieval_result_use_summary_manifest_admitted\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_summary_manifest_approval_admitted\":false",
            "\"result_use_summary_manifest_approval_admission_status\":\"result_use_summary_manifest_approval_not_admitted\"",
            "\"not_admitted_reason\":\"summary_manifest_not_approved\"",
            "\"result_use_summary_manifest_approval_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_smoke_consumes_admitted_approval(
) {
    let receipt = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_smoke_receipt();
    let approval_admission = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_hash,
        approval_admission.source_retrieval_result_use_summary_manifest_approval_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_readiness_hash,
        approval_admission.source_retrieval_result_use_summary_manifest_readiness_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_admission_hash,
        approval_admission.source_retrieval_result_use_summary_manifest_admission_hash
    );
    assert!(receipt.retrieval_result_use_summary_manifest_approval_admitted);
    assert!(receipt.retrieval_result_use_summary_manifest_approved);
    assert!(receipt.retrieval_result_use_summary_manifest_ready_for_use);
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.summary_manifest_approval_admission_consumption_policy_reuse_examples,
        approval_admission.summary_manifest_approval_admission_policy_reuse_examples
    );
    assert_eq!(
        receipt.summary_manifest_approval_admission_consumption_llm_fallback_examples,
    ...
    assert_eq!(receipt.not_consumed_reason, "none");
    assert_ne!(
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_regression_smoke_is_valid_not_consumed_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        approval_admission.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_smoke\"",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_summary_manifest_approval_admission_consumed\":true",
            "\"result_use_summary_manifest_approval_admission_consumption_status\":\"result_use_summary_manifest_approval_admission_consumed\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        "--policy-reuse-evidence-retrieval-result-use-summary-manifest-approval-admission-consumption-regression-smoke",
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_regression_smoke\"",
            "\"retrieval_result_use_summary_manifest_approval_admission_consumption_version\":1",
            "\"retrieval_result_use_summary_manifest_approval_admitted\":false",
            "\"retrieval_result_use_summary_manifest_approved\":false",
            "\"retrieval_result_use_summary_manifest_ready_for_use\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_result_use_summary_manifest_approval_admission_consumed\":false",
            "\"result_use_summary_manifest_approval_admission_consumption_status\":\"result_use_summary_manifest_approval_admission_not_consumed\"",
            "\"not_consumed_reason\":\"summary_manifest_approval_admission_not_admitted\"",
            "\"result_use_summary_manifest_approval_admission_consumption_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_smoke_marks_consumed_evidence_eligible(
) {
    let receipt = ai::validation_harness::
    ...
    let consumption = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ELIGIBILITY_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        consumption.source_retrieval_result_use_summary_manifest_approval_admission_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_hash,
        consumption.source_retrieval_result_use_summary_manifest_approval_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_readiness_hash,
        consumption.source_retrieval_result_use_summary_manifest_readiness_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_admission_hash,
        consumption.source_retrieval_result_use_summary_manifest_admission_hash
    );
    assert!(receipt.retrieval_result_use_summary_manifest_approval_admission_consumed);
    assert!(receipt.retrieval_result_use_summary_manifest_approval_admitted);
    assert!(receipt.retrieval_result_use_summary_manifest_approved);
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.retrieval_example_learning_eligibility_policy_reuse_examples,
        consumption.summary_manifest_approval_admission_consumption_policy_reuse_examples
    );
    assert_eq!(
        receipt.retrieval_example_learning_eligibility_llm_fallback_examples,
    ...
    assert_eq!(receipt.not_eligible_reason, "none");
    assert_ne!(receipt.retrieval_example_learning_eligibility_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_regression_smoke_is_valid_not_eligible_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ELIGIBILITY_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        consumption.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_smoke\"",
            ...
            "\"retrieval_example_learning_eligibility_status\":\"retrieval_example_learning_eligible\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_regression_smoke\"",
            "\"retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_version\":1",
            "\"retrieval_result_use_summary_manifest_approval_admission_consumed\":false",
            "\"retrieval_result_use_summary_manifest_approval_admitted\":false",
            "\"retrieval_result_use_summary_manifest_approved\":false",
            ...
            "\"retrieval_example_learning_eligibility_status\":\"retrieval_example_learning_not_eligible\"",
            "\"not_eligible_reason\":\"approval_admission_consumption_not_consumed\"",
            "\"retrieval_example_learning_eligibility_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_smoke_admits_eligible_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    let eligibility = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_eligibility_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ADMISSION_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        eligibility.source_retrieval_result_use_summary_manifest_approval_admission_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_hash,
        eligibility.source_retrieval_result_use_summary_manifest_approval_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_readiness_hash,
        eligibility.source_retrieval_result_use_summary_manifest_readiness_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_admission_hash,
        eligibility.source_retrieval_result_use_summary_manifest_admission_hash
    );
    assert!(receipt.retrieval_example_learning_eligible);
    assert!(receipt.retrieval_result_use_summary_manifest_approval_admission_consumed);
    assert!(receipt.retrieval_result_use_summary_manifest_approval_admitted);
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.retrieval_example_learning_admission_policy_reuse_examples,
        eligibility.retrieval_example_learning_eligibility_policy_reuse_examples
    );
    assert_eq!(
        receipt.retrieval_example_learning_admission_llm_fallback_examples,
    ...
    assert_eq!(receipt.not_admitted_reason, "none");
    assert_ne!(receipt.retrieval_example_learning_admission_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_regression_smoke_is_valid_not_admitted_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ADMISSION_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_example_learning_eligibility_hash,
        eligibility.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_smoke\"",
            ...
            "\"retrieval_example_learning_admission_status\":\"retrieval_example_learning_admitted\"",
            "\"not_admitted_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_regression_smoke\"",
            "\"retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_version\":1",
            "\"retrieval_example_learning_eligible\":false",
            "\"retrieval_result_use_summary_manifest_approval_admission_consumed\":false",
            "\"retrieval_result_use_summary_manifest_approval_admitted\":false",
            ...
            "\"retrieval_example_learning_admission_status\":\"retrieval_example_learning_not_admitted\"",
            "\"not_admitted_reason\":\"retrieval_example_learning_not_eligible\"",
            "\"retrieval_example_learning_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_smoke_packages_admitted_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_MATERIALIZATION_PLAN_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_example_learning_eligibility_hash,
        admission.source_retrieval_example_learning_eligibility_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        admission.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        admission.source_retrieval_result_use_summary_manifest_approval_admission_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_hash,
        admission.source_retrieval_result_use_summary_manifest_approval_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_readiness_hash,
        admission.source_retrieval_result_use_summary_manifest_readiness_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_admission_hash,
        admission.source_retrieval_result_use_summary_manifest_admission_hash
    );
    assert!(receipt.retrieval_example_learning_admitted);
    assert!(receipt.retrieval_example_learning_eligible);
    assert!(receipt.retrieval_result_use_summary_manifest_approval_admission_consumed);
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.materialization_plan_policy_reuse_examples,
        admission.retrieval_example_learning_admission_policy_reuse_examples
    );
    assert_eq!(
        receipt.materialization_plan_llm_fallback_examples,
    ...
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.retrieval_example_materialization_plan_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_regression_smoke_is_valid_not_ready_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_MATERIALIZATION_PLAN_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_example_learning_admission_hash,
        admission.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_smoke\"",
            ...
            "\"retrieval_example_materialization_plan_status\":\"retrieval_example_materialization_plan_ready\"",
            "\"not_ready_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_regression_smoke\"",
            "\"retrieval_example_learning_materialization_plan_version\":1",
            "\"retrieval_example_learning_admitted\":false",
            "\"retrieval_example_learning_eligible\":false",
            "\"retrieval_result_use_summary_manifest_approval_admission_consumed\":false",
            ...
            "\"retrieval_example_materialization_plan_status\":\"retrieval_example_materialization_plan_not_ready\"",
            "\"not_ready_reason\":\"retrieval_example_learning_not_admitted\"",
            "\"retrieval_example_materialization_plan_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_smoke_admits_ready_plan_without_writing_storage(
) {
    let receipt = ai::validation_harness::
    ...
    let plan = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_ADMISSION_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_example_learning_admission_hash,
        plan.source_retrieval_example_learning_admission_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_learning_eligibility_hash,
        plan.source_retrieval_example_learning_eligibility_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        plan.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        plan.source_retrieval_result_use_summary_manifest_approval_admission_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_approval_hash,
        plan.source_retrieval_result_use_summary_manifest_approval_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_readiness_hash,
        plan.source_retrieval_result_use_summary_manifest_readiness_hash
    );
    assert_eq!(
        receipt.source_retrieval_result_use_summary_manifest_admission_hash,
        plan.source_retrieval_result_use_summary_manifest_admission_hash
    );
    assert!(receipt.retrieval_example_materialization_plan_ready);
    assert!(receipt.retrieval_example_learning_admitted);
    assert!(receipt.retrieval_example_learning_eligible);
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.storage_admission_policy_reuse_examples,
        plan.materialization_plan_policy_reuse_examples
    );
    assert_eq!(
        receipt.storage_admission_llm_fallback_examples,
        plan.materialization_plan_llm_fallback_examples
    );
    ...
    assert_eq!(receipt.not_admitted_reason, "none");
    assert_ne!(receipt.retrieval_example_storage_admission_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_regression_smoke_is_valid_not_admitted_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_ADMISSION_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_example_materialization_plan_hash,
        plan.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_smoke\"",
            ...
            "\"retrieval_example_storage_admission_status\":\"retrieval_example_storage_admitted\"",
            "\"not_admitted_reason\":\"none\"",
            "\"retrieval_example_storage_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_regression_smoke\"",
            "\"retrieval_example_learning_storage_admission_version\":1",
            "\"retrieval_example_materialization_plan_ready\":false",
            "\"retrieval_example_learning_admitted\":false",
            "\"retrieval_example_learning_eligible\":false",
            ...
            "\"retrieval_example_storage_admission_status\":\"retrieval_example_storage_not_admitted\"",
            "\"not_admitted_reason\":\"retrieval_example_materialization_plan_not_ready\"",
            "\"retrieval_example_storage_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_smoke_packages_ready_intent_without_writing_storage(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_COMMIT_INTENT_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_example_storage_admission_hash,
        admission.receipt_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_materialization_plan_hash,
        admission.source_retrieval_example_materialization_plan_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_learning_admission_hash,
        admission.source_retrieval_example_learning_admission_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_learning_eligibility_hash,
        admission.source_retrieval_example_learning_eligibility_hash
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.storage_commit_intent_policy_reuse_examples,
        admission.storage_admission_policy_reuse_examples
    );
    assert_eq!(
        receipt.storage_commit_intent_llm_fallback_examples,
    ...
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.retrieval_example_storage_commit_intent_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_regression_smoke_is_valid_not_ready_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_COMMIT_INTENT_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_example_storage_admission_hash,
        admission.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_smoke\"",
            "\"retrieval_example_learning_storage_commit_intent_version\":1",
            "\"source_retrieval_example_storage_admission_hash\":",
            "\"source_retrieval_example_materialization_plan_hash\":",
            "\"source_retrieval_example_learning_admission_hash\":",
            "\"source_retrieval_example_learning_eligibility_hash\":",
            "\"retrieval_example_storage_admitted\":true",
            ...
            "\"retrieval_example_storage_commit_intent_status\":\"retrieval_example_storage_commit_intent_ready\"",
            "\"not_ready_reason\":\"none\"",
            "\"retrieval_example_storage_commit_intent_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_regression_smoke\"",
            "\"retrieval_example_learning_storage_commit_intent_version\":1",
            "\"source_retrieval_example_storage_admission_hash\":",
            "\"retrieval_example_storage_admitted\":false",
            "\"retrieval_example_materialization_plan_ready\":false",
            ...
            "\"retrieval_example_storage_commit_intent_status\":\"retrieval_example_storage_commit_intent_not_ready\"",
            "\"not_ready_reason\":\"retrieval_example_storage_not_admitted\"",
            "\"retrieval_example_storage_commit_intent_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_smoke_packages_ready_preflight_without_writing_storage(
) {
    let receipt = ai::validation_harness::
    ...
    let intent = ai::validation_harness::
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_commit_intent_smoke_receipt();
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_PREFLIGHT_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_example_materialization_plan_hash,
        intent.source_retrieval_example_materialization_plan_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_learning_admission_hash,
        intent.source_retrieval_example_learning_admission_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_learning_eligibility_hash,
        intent.source_retrieval_example_learning_eligibility_hash
    );
    assert!(receipt.retrieval_example_storage_commit_intent_ready);
    assert!(receipt.retrieval_example_storage_admitted);
    assert!(receipt.retrieval_example_materialization_plan_ready);
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.storage_write_preflight_policy_reuse_examples,
        intent.storage_commit_intent_policy_reuse_examples
    );
    assert_eq!(
        receipt.storage_write_preflight_llm_fallback_examples,
    ...
    assert_eq!(receipt.not_ready_reason, "none");
    assert_ne!(receipt.retrieval_example_storage_write_preflight_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_regression_smoke_is_valid_not_ready_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_PREFLIGHT_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_example_storage_commit_intent_hash,
        intent.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_smoke\"",
            ...
            "\"retrieval_example_storage_write_preflight_status\":\"retrieval_example_storage_write_preflight_ready\"",
            "\"not_ready_reason\":\"none\"",
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_regression_smoke\"",
            "\"retrieval_example_learning_storage_write_preflight_version\":1",
            "\"source_retrieval_example_storage_commit_intent_hash\":",
            "\"retrieval_example_storage_commit_intent_ready\":false",
            "\"retrieval_example_storage_admitted\":false",
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_smoke_admits_approved_write_without_writing_storage(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_ADMISSION_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_example_storage_write_preflight_hash,
        approval.source_retrieval_example_storage_write_preflight_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_storage_commit_intent_hash,
        approval.source_retrieval_example_storage_commit_intent_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_materialization_plan_hash,
        approval.source_retrieval_example_materialization_plan_hash
    );
    assert!(receipt.retrieval_example_storage_write_approved);
    assert!(receipt.retrieval_example_storage_write_preflight_ready);
    assert!(receipt.retrieval_example_storage_commit_intent_ready);
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.storage_write_admission_policy_reuse_examples,
        approval.storage_write_approval_policy_reuse_examples
    );
    assert_eq!(
        receipt.storage_write_admission_llm_fallback_examples,
        approval.storage_write_approval_llm_fallback_examples
    );
    assert!(receipt.retrieval_example_storage_write_admitted);
    assert_eq!(
        receipt.retrieval_example_storage_write_admission_status,
        "retrieval_example_storage_write_admitted"
    );
    assert_eq!(receipt.not_admitted_reason, "none");
    assert_ne!(receipt.retrieval_example_storage_write_admission_hash, 0);
    assert_ne!(receipt.receipt_hash, 0);
    assert!(receipt.is_valid());
    assert!(receipt.passed());
}
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_regression_smoke_is_valid_not_admitted_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_ADMISSION_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_example_storage_write_approval_hash,
        approval.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_smoke\"",
            "\"retrieval_example_learning_storage_write_admission_version\":1",
            "\"source_retrieval_example_storage_write_approval_hash\":",
            "\"source_retrieval_example_storage_write_preflight_hash\":",
            "\"source_retrieval_example_storage_commit_intent_hash\":",
            "\"retrieval_example_storage_write_approved\":true",
            "\"retrieval_example_storage_write_preflight_ready\":true",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_example_storage_write_admitted\":true",
            "\"retrieval_example_storage_write_admission_status\":\"retrieval_example_storage_write_admitted\"",
            "\"not_admitted_reason\":\"none\"",
            "\"retrieval_example_storage_write_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_regression_smoke\"",
            "\"retrieval_example_learning_storage_write_admission_version\":1",
            "\"source_retrieval_example_storage_write_approval_hash\":",
            "\"retrieval_example_storage_write_approved\":false",
            "\"retrieval_example_storage_write_preflight_ready\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_example_storage_write_admitted\":false",
            "\"retrieval_example_storage_write_admission_status\":\"retrieval_example_storage_write_not_admitted\"",
            "\"not_admitted_reason\":\"retrieval_example_storage_write_not_approved\"",
            "\"retrieval_example_storage_write_admission_hash\":",
            "\"receipt_hash\":",
        ],
    );
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_smoke_commits_intent_without_writing_storage(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_COMMIT_INTENT_SMOKE_STEP
    );
    assert_eq!(
    ...
    assert_eq!(
        receipt.source_retrieval_example_storage_write_approval_hash,
        admission.source_retrieval_example_storage_write_approval_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_storage_write_preflight_hash,
        admission.source_retrieval_example_storage_write_preflight_hash
    );
    assert_eq!(
        receipt.source_retrieval_example_storage_commit_intent_hash,
        admission.source_retrieval_example_storage_commit_intent_hash
    );
    assert!(receipt.retrieval_example_storage_write_admitted);
    assert!(receipt.retrieval_example_storage_write_approved);
    assert!(receipt.retrieval_example_storage_write_preflight_ready);
    ...
    assert!(receipt.external_result_evidence_present);
    assert_eq!(
        receipt.storage_write_commit_intent_policy_reuse_examples,
        admission.storage_write_admission_policy_reuse_examples
    );
    assert_eq!(
        receipt.storage_write_commit_intent_llm_fallback_examples,
        admission.storage_write_admission_llm_fallback_examples
    );
    assert!(receipt.retrieval_example_storage_write_commit_intent_ready);
    assert_eq!(
...
#[test]
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_regression_smoke_is_valid_not_ready_evidence(
) {
    let receipt = ai::validation_harness::
    ...
    assert_eq!(
        receipt.record_type,
        ai::validation_harness::POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_COMMIT_INTENT_REGRESSION_SMOKE_STEP
    );
    assert_eq!(
        receipt.source_retrieval_example_storage_write_admission_hash,
        admission.receipt_hash
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            ...
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_smoke\"",
            "\"retrieval_example_learning_storage_write_commit_intent_version\":1",
            "\"source_retrieval_example_storage_write_admission_hash\":",
            "\"source_retrieval_example_storage_write_approval_hash\":",
            "\"source_retrieval_example_storage_write_preflight_hash\":",
            "\"source_retrieval_example_storage_commit_intent_hash\":",
            "\"retrieval_example_storage_write_admitted\":true",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_example_storage_write_commit_intent_ready\":true",
            "\"retrieval_example_storage_write_commit_intent_status\":\"retrieval_example_storage_write_commit_intent_ready\"",
            "\"not_ready_reason\":\"none\"",
            "\"retrieval_example_storage_write_commit_intent_hash\":",
            "\"receipt_hash\":",
        ],
    );
}
...
#[test]
fn root_validate_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_regression_smoke_mode_is_executable_contract(
) {
    assert_root_validate_catalog_compact_mode_contract(
        ...
        &[
            "\"schema\":\"canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_v1\"",
            "\"record_type\":\"policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_regression_smoke\"",
            "\"retrieval_example_learning_storage_write_commit_intent_version\":1",
            "\"source_retrieval_example_storage_write_admission_hash\":",
            "\"retrieval_example_storage_write_admitted\":false",
            "\"retrieval_example_storage_write_approved\":false",
            ...
            "\"student_training_performed\":false",
            "\"external_result_evidence_present\":true",
            "\"retrieval_example_storage_write_commit_intent_ready\":false",
            "\"retrieval_example_storage_write_commit_intent_status\":\"retrieval_example_storage_write_commit_intent_not_ready\"",
            "\"not_ready_reason\":\"retrieval_example_storage_write_not_admitted\"",
            "\"retrieval_example_storage_write_commit_intent_hash\":",
            "\"receipt_hash\":",
        ],
    );
