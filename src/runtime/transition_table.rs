...
pub(crate) const TRANSITIONS: [Transition; 46] = [
    Transition { from: Phase::Delta, to: Phase::Invariant, kind: EventKind::Advanced, cause: Cause::Start },
    Transition { from: Phase::Invariant, to: Phase::Invariant, kind: EventKind::Persisted, cause: Cause::EvidenceSubmitted },
    ...
    Transition { from: Phase::Analysis, to: Phase::Analysis, kind: EventKind::Persisted, cause: Cause::EvidenceSubmitted },
    ...
    Transition { from: Phase::Judgment, to: Phase::Judgment, kind: EventKind::Persisted, cause: Cause::EvidenceSubmitted },
    ...
    Transition { from: Phase::Plan, to: Phase::Plan, kind: EventKind::Persisted, cause: Cause::EvidenceSubmitted },
    ...
    Transition { from: Phase::Execute, to: Phase::Execute, kind: EventKind::Persisted, cause: Cause::EvidenceSubmitted },
    ...
    Transition { from: Phase::Verify, to: Phase::Verify, kind: EventKind::Persisted, cause: Cause::EvidenceSubmitted },
    ...
    Transition { from: Phase::Eval, to: Phase::Eval, kind: EventKind::Persisted, cause: Cause::EvidenceSubmitted },
    ...
    Transition { from: Phase::Learn, to: Phase::Learn, kind: EventKind::Persisted, cause: Cause::EvidenceSubmitted },
