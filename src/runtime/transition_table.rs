...
pub(crate) const TRANSITIONS: [Transition; 46] = [
    ...
    Transition {
        ...
        to: Phase::Recovery,
        kind: EventKind::Failed,
        cause: Cause::TaskReceiptMissing,
    },
    Transition {
        from: Phase::Verify,
        to: Phase::Verify,
    ...
    Transition {
        ...
        to: Phase::Eval,
        kind: EventKind::Advanced,
        cause: Cause::VerificationPassed,
    },
    Transition {
        from: Phase::Verify,
        to: Phase::Recovery,
    ...
    Transition {
        ...
        to: Phase::Recovery,
        kind: EventKind::Failed,
        cause: Cause::ArtifactLineageBroken,
    },
    Transition {
        from: Phase::Eval,
        to: Phase::Eval,
