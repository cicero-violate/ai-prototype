...
pub use supervisor::{
    ...
    ai_workspace_update, build_supervisor_router, command_gateway, get_task_next, health, reload,
    require_ai_mcp_auth, spawn_agent_handler, start_agent_loop_handler,
};
