...
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_ADMISSION_SMOKE_STEP: &str =
    "policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_ADMISSION_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_READINESS_SMOKE_STEP: &str =
    "policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_READINESS_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_SMOKE_STEP: &str =
    "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_SMOKE_STEP:
...
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ADMISSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ADMISSION_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_MATERIALIZATION_PLAN_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_MATERIALIZATION_PLAN_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_ADMISSION_SMOKE_STEP:
...
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_PREFLIGHT_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_PREFLIGHT_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_APPROVAL_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_APPROVAL_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_ADMISSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_ADMISSION_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_regression_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_COMMIT_INTENT_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_smoke";
pub const POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_COMMIT_INTENT_REGRESSION_SMOKE_STEP:
    &str = "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_regression_smoke";
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestAdmissionReceipt {
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_result_use_summary_manifest_admission_version: u64,
    pub source_retrieval_result_use_summary_manifest_hash: u64,
    pub source_retrieval_result_use_summary_hash: u64,
    pub retrieval_result_use_summary_manifest_ready: bool,
    pub retrieval_result_use_summary_ready: bool,
    pub retrieval_read_performed: bool,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub summary_manifest_admission_policy_reuse_examples: usize,
    pub summary_manifest_admission_llm_fallback_examples: usize,
    pub retrieval_result_use_summary_manifest_admitted: bool,
    pub result_use_summary_manifest_admission_status: &'static str,
    pub not_admitted_reason: &'static str,
    pub result_use_summary_manifest_admission_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestAdmissionReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_result_use_summary_manifest_admitted
            && self.result_use_summary_manifest_admission_status
                == "result_use_summary_manifest_admitted"
    }

    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_admission"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_ADMISSION_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_ADMISSION_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_result_use_summary_manifest_admission_version == 1
            && self.source_retrieval_result_use_summary_manifest_hash != 0
            && self.source_retrieval_result_use_summary_hash != 0
            && !self.retrieval_read_performed
            && !self.retrieval_write_performed
            && !self.retrieval_query_executed
            ...
            && !self.policy_promotion_performed
            && !self.student_training_performed
            && self.summary_manifest_admission_policy_reuse_examples > 0
            && matches!(
                self.result_use_summary_manifest_admission_status,
                "result_use_summary_manifest_admitted"
            ...
            && (self.result_use_summary_manifest_admission_status
                == "result_use_summary_manifest_admitted")
                == self.retrieval_result_use_summary_manifest_admitted
            && self.result_use_summary_manifest_admission_hash != 0
            && self.receipt_hash != 0
            && self.result_use_summary_manifest_admission_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_result_use_summary_manifest_admission_version\":{},\"source_retrieval_result_use_summary_manifest_hash\":{},\"source_retrieval_result_use_summary_hash\":{},\"retrieval_result_use_summary_manifest_ready\":{},\"retrieval_result_use_summary_ready\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"summary_manifest_admission_policy_reuse_examples\":{},\"summary_manifest_admission_llm_fallback_examples\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"result_use_summary_manifest_admission_status\":\"{}\",\"not_admitted_reason\":\"{}\",\"result_use_summary_manifest_admission_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_result_use_summary_manifest_admission_version,
            self.source_retrieval_result_use_summary_manifest_hash,
            self.source_retrieval_result_use_summary_hash,
            self.retrieval_result_use_summary_manifest_ready,
            self.retrieval_result_use_summary_ready,
            self.retrieval_read_performed,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.summary_manifest_admission_policy_reuse_examples,
            self.summary_manifest_admission_llm_fallback_examples,
            self.retrieval_result_use_summary_manifest_admitted,
            self.result_use_summary_manifest_admission_status,
            self.not_admitted_reason,
            self.result_use_summary_manifest_admission_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestReadinessReceipt {
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_result_use_summary_manifest_readiness_version: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub summary_manifest_readiness_policy_reuse_examples: usize,
    pub summary_manifest_readiness_llm_fallback_examples: usize,
    pub retrieval_result_use_summary_manifest_ready_for_use: bool,
    pub result_use_summary_manifest_readiness_status: &'static str,
    pub not_ready_reason: &'static str,
    pub result_use_summary_manifest_readiness_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestReadinessReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_result_use_summary_manifest_ready_for_use
            && self.result_use_summary_manifest_readiness_status
                == "result_use_summary_manifest_ready_for_use"
    }

    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_READINESS_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_READINESS_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_result_use_summary_manifest_readiness_version == 1
            ...
            && !self.policy_promotion_performed
            && !self.student_training_performed
            && self.summary_manifest_readiness_policy_reuse_examples > 0
            && matches!(
                self.result_use_summary_manifest_readiness_status,
                "result_use_summary_manifest_ready_for_use"
            ...
            && (self.result_use_summary_manifest_readiness_status
                == "result_use_summary_manifest_ready_for_use")
                == self.retrieval_result_use_summary_manifest_ready_for_use
            && self.result_use_summary_manifest_readiness_hash != 0
            && self.receipt_hash != 0
            && self.result_use_summary_manifest_readiness_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_result_use_summary_manifest_readiness_version\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_hash\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_result_use_summary_manifest_ready\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"summary_manifest_readiness_policy_reuse_examples\":{},\"summary_manifest_readiness_llm_fallback_examples\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"result_use_summary_manifest_readiness_status\":\"{}\",\"not_ready_reason\":\"{}\",\"result_use_summary_manifest_readiness_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_result_use_summary_manifest_readiness_version,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.summary_manifest_readiness_policy_reuse_examples,
            self.summary_manifest_readiness_llm_fallback_examples,
            self.retrieval_result_use_summary_manifest_ready_for_use,
            self.result_use_summary_manifest_readiness_status,
            self.not_ready_reason,
            self.result_use_summary_manifest_readiness_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalReceipt {
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_result_use_summary_manifest_approval_version: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub summary_manifest_approval_policy_reuse_examples: usize,
    pub summary_manifest_approval_llm_fallback_examples: usize,
    pub retrieval_result_use_summary_manifest_approved: bool,
    pub result_use_summary_manifest_approval_status: &'static str,
    pub not_approved_reason: &'static str,
    pub result_use_summary_manifest_approval_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_result_use_summary_manifest_approved
            && self.result_use_summary_manifest_approval_status
    ...
    pub fn is_valid(&self) -> bool {
        self.schema
            ...
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_result_use_summary_manifest_approval_version == 1
            ...
            && !self.policy_promotion_performed
            && !self.student_training_performed
            && self.summary_manifest_approval_policy_reuse_examples > 0
            && matches!(
                self.result_use_summary_manifest_approval_status,
                "result_use_summary_manifest_approved"
            ...
            && (self.result_use_summary_manifest_approval_status
                == "result_use_summary_manifest_approved")
                == self.retrieval_result_use_summary_manifest_approved
            && self.result_use_summary_manifest_approval_hash != 0
            && self.receipt_hash != 0
            && self.result_use_summary_manifest_approval_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_result_use_summary_manifest_approval_version\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"summary_manifest_approval_policy_reuse_examples\":{},\"summary_manifest_approval_llm_fallback_examples\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"result_use_summary_manifest_approval_status\":\"{}\",\"not_approved_reason\":\"{}\",\"result_use_summary_manifest_approval_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_result_use_summary_manifest_approval_version,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.summary_manifest_approval_policy_reuse_examples,
            self.summary_manifest_approval_llm_fallback_examples,
            self.retrieval_result_use_summary_manifest_approved,
            self.result_use_summary_manifest_approval_status,
            self.not_approved_reason,
            self.result_use_summary_manifest_approval_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionReceipt {
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_result_use_summary_manifest_approval_admission_version: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub summary_manifest_approval_admission_policy_reuse_examples: usize,
    pub summary_manifest_approval_admission_llm_fallback_examples: usize,
    pub retrieval_result_use_summary_manifest_approval_admitted: bool,
    pub result_use_summary_manifest_approval_admission_status: &'static str,
    pub not_admitted_reason: &'static str,
    pub result_use_summary_manifest_approval_admission_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_result_use_summary_manifest_approval_admitted
            && self.result_use_summary_manifest_approval_admission_status
                == "result_use_summary_manifest_approval_admitted"
    }

    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_result_use_summary_manifest_approval_admission_version == 1
            ...
            && !self.policy_promotion_performed
            && !self.student_training_performed
            && self.summary_manifest_approval_admission_policy_reuse_examples > 0
            && matches!(
                self.result_use_summary_manifest_approval_admission_status,
                "result_use_summary_manifest_approval_admitted"
            ...
            && (self.result_use_summary_manifest_approval_admission_status
                == "result_use_summary_manifest_approval_admitted")
                == self.retrieval_result_use_summary_manifest_approval_admitted
            && self.result_use_summary_manifest_approval_admission_hash != 0
            && self.receipt_hash != 0
            && self.result_use_summary_manifest_approval_admission_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_result_use_summary_manifest_approval_admission_version\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"summary_manifest_approval_admission_policy_reuse_examples\":{},\"summary_manifest_approval_admission_llm_fallback_examples\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"result_use_summary_manifest_approval_admission_status\":\"{}\",\"not_admitted_reason\":\"{}\",\"result_use_summary_manifest_approval_admission_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_result_use_summary_manifest_approval_admission_version,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.summary_manifest_approval_admission_policy_reuse_examples,
            self.summary_manifest_approval_admission_llm_fallback_examples,
            self.retrieval_result_use_summary_manifest_approval_admitted,
            self.result_use_summary_manifest_approval_admission_status,
            self.not_admitted_reason,
            self.result_use_summary_manifest_approval_admission_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionReceipt {
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_result_use_summary_manifest_approval_admission_consumption_version: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub summary_manifest_approval_admission_consumption_policy_reuse_examples: usize,
    pub summary_manifest_approval_admission_consumption_llm_fallback_examples: usize,
    pub retrieval_result_use_summary_manifest_approval_admission_consumed: bool,
    pub result_use_summary_manifest_approval_admission_consumption_status: &'static str,
    pub not_consumed_reason: &'static str,
    pub result_use_summary_manifest_approval_admission_consumption_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            ...
            && self.result_use_summary_manifest_approval_admission_consumption_status
                == "result_use_summary_manifest_approval_admission_consumed"
    }

    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_result_use_summary_manifest_approval_admission_consumption_version == 1
            ...
            && !self.student_training_performed
            && self.summary_manifest_approval_admission_consumption_policy_reuse_examples > 0
            && matches!(
                self.result_use_summary_manifest_approval_admission_consumption_status,
                "result_use_summary_manifest_approval_admission_consumed"
            ...
            && self.retrieval_result_use_summary_manifest_approval_admission_consumed
                == (self.retrieval_result_use_summary_manifest_approval_admitted
                    ...
                    && !self.student_training_performed
                    && self.summary_manifest_approval_admission_consumption_policy_reuse_examples > 0
                    && self.not_consumed_reason == "none")
            && (self.result_use_summary_manifest_approval_admission_consumption_status
                == "result_use_summary_manifest_approval_admission_consumed")
                == self.retrieval_result_use_summary_manifest_approval_admission_consumed
            && self.result_use_summary_manifest_approval_admission_consumption_hash != 0
            && self.receipt_hash != 0
            && self.result_use_summary_manifest_approval_admission_consumption_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_result_use_summary_manifest_approval_admission_consumption_version\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"batch_execution_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"summary_manifest_approval_admission_consumption_policy_reuse_examples\":{},\"summary_manifest_approval_admission_consumption_llm_fallback_examples\":{},\"retrieval_result_use_summary_manifest_approval_admission_consumed\":{},\"result_use_summary_manifest_approval_admission_consumption_status\":\"{}\",\"not_consumed_reason\":\"{}\",\"result_use_summary_manifest_approval_admission_consumption_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_result_use_summary_manifest_approval_admission_consumption_version,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.summary_manifest_approval_admission_consumption_policy_reuse_examples,
            self.summary_manifest_approval_admission_consumption_llm_fallback_examples,
            self.retrieval_result_use_summary_manifest_approval_admission_consumed,
            self.result_use_summary_manifest_approval_admission_consumption_status,
            self.not_consumed_reason,
            self.result_use_summary_manifest_approval_admission_consumption_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningAdmissionReceipt
{
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_version:
        u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub retrieval_example_learning_admission_policy_reuse_examples: usize,
    pub retrieval_example_learning_admission_llm_fallback_examples: usize,
    pub retrieval_example_learning_admitted: bool,
    pub retrieval_example_learning_admission_status: &'static str,
    pub not_admitted_reason: &'static str,
    pub retrieval_example_learning_admission_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningAdmissionReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_example_learning_admitted
            && self.retrieval_example_learning_admission_status
                == "retrieval_example_learning_admitted"
    }

    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ADMISSION_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ADMISSION_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_version == 1
            ...
            && !self.batch_execution_performed
            && !self.student_training_performed
            && self.retrieval_example_learning_admission_policy_reuse_examples > 0
            && matches!(
                self.retrieval_example_learning_admission_status,
                "retrieval_example_learning_admitted" | "retrieval_example_learning_not_admitted"
            )
            && matches!(
                self.not_admitted_reason,
                "none"
            ...
            && (self.retrieval_example_learning_admission_status
                == "retrieval_example_learning_admitted")
                == self.retrieval_example_learning_admitted
            && self.retrieval_example_learning_admission_hash != 0
            && self.receipt_hash != 0
            && self.retrieval_example_learning_admission_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_version\":{},\"source_retrieval_example_learning_eligibility_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_example_learning_eligible\":{},\"retrieval_result_use_summary_manifest_approval_admission_consumed\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"batch_execution_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"retrieval_example_learning_admission_policy_reuse_examples\":{},\"retrieval_example_learning_admission_llm_fallback_examples\":{},\"retrieval_example_learning_admitted\":{},\"retrieval_example_learning_admission_status\":\"{}\",\"not_admitted_reason\":\"{}\",\"retrieval_example_learning_admission_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_version,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.retrieval_example_learning_admission_policy_reuse_examples,
            self.retrieval_example_learning_admission_llm_fallback_examples,
            self.retrieval_example_learning_admitted,
            self.retrieval_example_learning_admission_status,
            self.not_admitted_reason,
            self.retrieval_example_learning_admission_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningMaterializationPlanReceipt
{
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_example_learning_materialization_plan_version: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub materialization_plan_policy_reuse_examples: usize,
    pub materialization_plan_llm_fallback_examples: usize,
    pub retrieval_example_materialization_plan_ready: bool,
    pub retrieval_example_materialization_plan_status: &'static str,
    pub not_ready_reason: &'static str,
    pub retrieval_example_materialization_plan_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningMaterializationPlanReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
    ...
    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_MATERIALIZATION_PLAN_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_MATERIALIZATION_PLAN_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_example_learning_materialization_plan_version == 1
            ...
            && matches!(
                self.retrieval_example_materialization_plan_status,
                "retrieval_example_materialization_plan_ready" | "retrieval_example_materialization_plan_not_ready"
            )
            && matches!(
                self.not_ready_reason,
                "none"
            ...
            && (self.retrieval_example_materialization_plan_status
                == "retrieval_example_materialization_plan_ready")
                == self.retrieval_example_materialization_plan_ready
            && self.retrieval_example_materialization_plan_hash != 0
            && self.receipt_hash != 0
            && self.retrieval_example_materialization_plan_hash
    ...
    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_example_learning_materialization_plan_version\":{},\"source_retrieval_example_learning_admission_hash\":{},\"source_retrieval_example_learning_eligibility_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_example_learning_admitted\":{},\"retrieval_example_learning_eligible\":{},\"retrieval_result_use_summary_manifest_approval_admission_consumed\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"batch_execution_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"materialization_plan_policy_reuse_examples\":{},\"materialization_plan_llm_fallback_examples\":{},\"retrieval_example_materialization_plan_ready\":{},\"retrieval_example_materialization_plan_status\":\"{}\",\"not_ready_reason\":\"{}\",\"retrieval_example_materialization_plan_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_example_learning_materialization_plan_version,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.materialization_plan_policy_reuse_examples,
            self.materialization_plan_llm_fallback_examples,
            self.retrieval_example_materialization_plan_ready,
            self.retrieval_example_materialization_plan_status,
            self.not_ready_reason,
            self.retrieval_example_materialization_plan_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageAdmissionReceipt
{
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_example_learning_storage_admission_version: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub storage_admission_policy_reuse_examples: usize,
    pub storage_admission_llm_fallback_examples: usize,
    pub retrieval_example_storage_admitted: bool,
    pub retrieval_example_storage_admission_status: &'static str,
    pub not_admitted_reason: &'static str,
    pub retrieval_example_storage_admission_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageAdmissionReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
    ...
    pub fn is_valid(&self) -> bool {
        self.schema
            ...
            && (self.retrieval_example_storage_admission_status
                == "retrieval_example_storage_admitted")
                == self.retrieval_example_storage_admitted
            && self.retrieval_example_storage_admission_hash != 0
            && self.receipt_hash != 0
            && self.retrieval_example_storage_admission_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_example_learning_storage_admission_version\":{},\"source_retrieval_example_materialization_plan_hash\":{},\"source_retrieval_example_learning_admission_hash\":{},\"source_retrieval_example_learning_eligibility_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_example_materialization_plan_ready\":{},\"retrieval_example_learning_admitted\":{},\"retrieval_example_learning_eligible\":{},\"retrieval_result_use_summary_manifest_approval_admission_consumed\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"batch_execution_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"storage_admission_policy_reuse_examples\":{},\"storage_admission_llm_fallback_examples\":{},\"retrieval_example_storage_admitted\":{},\"retrieval_example_storage_admission_status\":\"{}\",\"not_admitted_reason\":\"{}\",\"retrieval_example_storage_admission_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_example_learning_storage_admission_version,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.storage_admission_policy_reuse_examples,
            self.storage_admission_llm_fallback_examples,
            self.retrieval_example_storage_admitted,
            self.retrieval_example_storage_admission_status,
            self.not_admitted_reason,
            self.retrieval_example_storage_admission_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWritePreflightReceipt
{
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_example_learning_storage_write_preflight_version: u64,
    pub source_retrieval_example_storage_commit_intent_hash: u64,
    pub source_retrieval_example_materialization_plan_hash: u64,
    pub source_retrieval_example_learning_admission_hash: u64,
    pub source_retrieval_example_learning_eligibility_hash: u64,
    pub source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub storage_write_preflight_policy_reuse_examples: usize,
    pub storage_write_preflight_llm_fallback_examples: usize,
    pub retrieval_example_storage_write_preflight_ready: bool,
    pub retrieval_example_storage_write_preflight_status: &'static str,
    pub not_ready_reason: &'static str,
    pub retrieval_example_storage_write_preflight_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWritePreflightReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_example_storage_write_preflight_ready
            && self.retrieval_example_storage_write_preflight_status
                == "retrieval_example_storage_write_preflight_ready"
    }

    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_PREFLIGHT_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_PREFLIGHT_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_example_learning_storage_write_preflight_version == 1
            && self.source_retrieval_example_storage_commit_intent_hash != 0
            && self.source_retrieval_example_materialization_plan_hash != 0
            && self.source_retrieval_example_learning_admission_hash != 0
            && self.source_retrieval_example_learning_eligibility_hash != 0
            && self.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash != 0
            ...
            && !self.batch_execution_performed
            && !self.student_training_performed
            && self.storage_write_preflight_policy_reuse_examples > 0
            && matches!(
                self.retrieval_example_storage_write_preflight_status,
                "retrieval_example_storage_write_preflight_ready"
            ...
            && matches!(
                self.not_ready_reason,
                "none" | "retrieval_example_storage_commit_intent_not_ready"
            )
            && self.retrieval_example_storage_write_preflight_ready
                == (self.retrieval_example_storage_commit_intent_ready
                    && self.retrieval_example_storage_admitted
            ...
            && (self.retrieval_example_storage_write_preflight_status
                == "retrieval_example_storage_write_preflight_ready")
                == self.retrieval_example_storage_write_preflight_ready
            && self.retrieval_example_storage_write_preflight_hash != 0
            && self.receipt_hash != 0
            && self.retrieval_example_storage_write_preflight_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_example_learning_storage_write_preflight_version\":{},\"source_retrieval_example_storage_commit_intent_hash\":{},\"source_retrieval_example_materialization_plan_hash\":{},\"source_retrieval_example_learning_admission_hash\":{},\"source_retrieval_example_learning_eligibility_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_example_storage_commit_intent_ready\":{},\"retrieval_example_storage_admitted\":{},\"retrieval_example_materialization_plan_ready\":{},\"retrieval_example_learning_admitted\":{},\"retrieval_example_learning_eligible\":{},\"retrieval_result_use_summary_manifest_approval_admission_consumed\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"batch_execution_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"storage_write_preflight_policy_reuse_examples\":{},\"storage_write_preflight_llm_fallback_examples\":{},\"retrieval_example_storage_write_preflight_ready\":{},\"retrieval_example_storage_write_preflight_status\":\"{}\",\"not_ready_reason\":\"{}\",\"retrieval_example_storage_write_preflight_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_example_learning_storage_write_preflight_version,
            self.source_retrieval_example_storage_commit_intent_hash,
            self.source_retrieval_example_materialization_plan_hash,
            self.source_retrieval_example_learning_admission_hash,
            self.source_retrieval_example_learning_eligibility_hash,
            self.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.storage_write_preflight_policy_reuse_examples,
            self.storage_write_preflight_llm_fallback_examples,
            self.retrieval_example_storage_write_preflight_ready,
            self.retrieval_example_storage_write_preflight_status,
            self.not_ready_reason,
            self.retrieval_example_storage_write_preflight_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteApprovalReceipt
{
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_example_learning_storage_write_approval_version: u64,
    pub source_retrieval_example_storage_write_preflight_hash: u64,
    pub source_retrieval_example_storage_commit_intent_hash: u64,
    pub source_retrieval_example_materialization_plan_hash: u64,
    pub source_retrieval_example_learning_admission_hash: u64,
    pub source_retrieval_example_learning_eligibility_hash: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub storage_write_approval_policy_reuse_examples: usize,
    pub storage_write_approval_llm_fallback_examples: usize,
    pub retrieval_example_storage_write_approved: bool,
    pub retrieval_example_storage_write_approval_status: &'static str,
    pub not_approved_reason: &'static str,
    pub retrieval_example_storage_write_approval_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteApprovalReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_example_storage_write_approved
            && self.retrieval_example_storage_write_approval_status
    ...
    pub fn is_valid(&self) -> bool {
        self.schema
            ...
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_APPROVAL_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_APPROVAL_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_example_learning_storage_write_approval_version == 1
            && self.source_retrieval_example_storage_write_preflight_hash != 0
            && self.source_retrieval_example_storage_commit_intent_hash != 0
            && self.source_retrieval_example_materialization_plan_hash != 0
            && self.source_retrieval_example_learning_admission_hash != 0
            && self.source_retrieval_example_learning_eligibility_hash != 0
            ...
            && !self.batch_execution_performed
            && !self.student_training_performed
            && self.storage_write_approval_policy_reuse_examples > 0
            && matches!(
                self.retrieval_example_storage_write_approval_status,
                "retrieval_example_storage_write_approved"
            ...
            && matches!(
                self.not_approved_reason,
                "none" | "retrieval_example_storage_write_preflight_not_ready"
            )
            && self.retrieval_example_storage_write_approved
                == (self.retrieval_example_storage_write_preflight_ready
                    && self.retrieval_example_storage_commit_intent_ready
            ...
            && (self.retrieval_example_storage_write_approval_status
                == "retrieval_example_storage_write_approved")
                == self.retrieval_example_storage_write_approved
            && self.retrieval_example_storage_write_approval_hash != 0
            && self.receipt_hash != 0
            && self.retrieval_example_storage_write_approval_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_example_learning_storage_write_approval_version\":{},\"source_retrieval_example_storage_write_preflight_hash\":{},\"source_retrieval_example_storage_commit_intent_hash\":{},\"source_retrieval_example_materialization_plan_hash\":{},\"source_retrieval_example_learning_admission_hash\":{},\"source_retrieval_example_learning_eligibility_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_example_storage_write_preflight_ready\":{},\"retrieval_example_storage_commit_intent_ready\":{},\"retrieval_example_storage_admitted\":{},\"retrieval_example_materialization_plan_ready\":{},\"retrieval_example_learning_admitted\":{},\"retrieval_example_learning_eligible\":{},\"retrieval_result_use_summary_manifest_approval_admission_consumed\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"batch_execution_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"storage_write_approval_policy_reuse_examples\":{},\"storage_write_approval_llm_fallback_examples\":{},\"retrieval_example_storage_write_approved\":{},\"retrieval_example_storage_write_approval_status\":\"{}\",\"not_approved_reason\":\"{}\",\"retrieval_example_storage_write_approval_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_example_learning_storage_write_approval_version,
            self.source_retrieval_example_storage_write_preflight_hash,
            self.source_retrieval_example_storage_commit_intent_hash,
            self.source_retrieval_example_materialization_plan_hash,
            self.source_retrieval_example_learning_admission_hash,
            self.source_retrieval_example_learning_eligibility_hash,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.storage_write_approval_policy_reuse_examples,
            self.storage_write_approval_llm_fallback_examples,
            self.retrieval_example_storage_write_approved,
            self.retrieval_example_storage_write_approval_status,
            self.not_approved_reason,
            self.retrieval_example_storage_write_approval_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteAdmissionReceipt
{
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_example_learning_storage_write_admission_version: u64,
    pub source_retrieval_example_storage_write_approval_hash: u64,
    pub source_retrieval_example_storage_write_preflight_hash: u64,
    pub source_retrieval_example_storage_commit_intent_hash: u64,
    pub source_retrieval_example_materialization_plan_hash: u64,
    pub source_retrieval_example_learning_admission_hash: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub storage_write_admission_policy_reuse_examples: usize,
    pub storage_write_admission_llm_fallback_examples: usize,
    pub retrieval_example_storage_write_admitted: bool,
    pub retrieval_example_storage_write_admission_status: &'static str,
    pub not_admitted_reason: &'static str,
    pub retrieval_example_storage_write_admission_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteAdmissionReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_example_storage_write_admitted
            && self.retrieval_example_storage_write_admission_status
                == "retrieval_example_storage_write_admitted"
    }

    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_ADMISSION_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_ADMISSION_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_example_learning_storage_write_admission_version == 1
            && self.source_retrieval_example_storage_write_approval_hash != 0
            && self.source_retrieval_example_storage_write_preflight_hash != 0
            && self.source_retrieval_example_storage_commit_intent_hash != 0
            && self.source_retrieval_example_materialization_plan_hash != 0
            && self.source_retrieval_example_learning_admission_hash != 0
            ...
            && !self.batch_execution_performed
            && !self.student_training_performed
            && self.storage_write_admission_policy_reuse_examples > 0
            && matches!(
                self.retrieval_example_storage_write_admission_status,
                "retrieval_example_storage_write_admitted"
            ...
            && matches!(
                self.not_admitted_reason,
                "none" | "retrieval_example_storage_write_not_approved"
            )
            && self.retrieval_example_storage_write_admitted
                == (self.retrieval_example_storage_write_approved
                    && self.retrieval_example_storage_write_preflight_ready
            ...
            && (self.retrieval_example_storage_write_admission_status
                == "retrieval_example_storage_write_admitted")
                == self.retrieval_example_storage_write_admitted
            && self.retrieval_example_storage_write_admission_hash != 0
            && self.receipt_hash != 0
            && self.retrieval_example_storage_write_admission_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_example_learning_storage_write_admission_version\":{},\"source_retrieval_example_storage_write_approval_hash\":{},\"source_retrieval_example_storage_write_preflight_hash\":{},\"source_retrieval_example_storage_commit_intent_hash\":{},\"source_retrieval_example_materialization_plan_hash\":{},\"source_retrieval_example_learning_admission_hash\":{},\"source_retrieval_example_learning_eligibility_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_example_storage_write_approved\":{},\"retrieval_example_storage_write_preflight_ready\":{},\"retrieval_example_storage_commit_intent_ready\":{},\"retrieval_example_storage_admitted\":{},\"retrieval_example_materialization_plan_ready\":{},\"retrieval_example_learning_admitted\":{},\"retrieval_example_learning_eligible\":{},\"retrieval_result_use_summary_manifest_approval_admission_consumed\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"batch_execution_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"storage_write_admission_policy_reuse_examples\":{},\"storage_write_admission_llm_fallback_examples\":{},\"retrieval_example_storage_write_admitted\":{},\"retrieval_example_storage_write_admission_status\":\"{}\",\"not_admitted_reason\":\"{}\",\"retrieval_example_storage_write_admission_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_example_learning_storage_write_admission_version,
            self.source_retrieval_example_storage_write_approval_hash,
            self.source_retrieval_example_storage_write_preflight_hash,
            self.source_retrieval_example_storage_commit_intent_hash,
            self.source_retrieval_example_materialization_plan_hash,
            self.source_retrieval_example_learning_admission_hash,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.storage_write_admission_policy_reuse_examples,
            self.storage_write_admission_llm_fallback_examples,
            self.retrieval_example_storage_write_admitted,
            self.retrieval_example_storage_write_admission_status,
            self.not_admitted_reason,
            self.retrieval_example_storage_write_admission_hash,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteCommitIntentReceipt
{
    pub schema: &'static str,
    pub record_type: &'static str,
    pub retrieval_example_learning_storage_write_commit_intent_version: u64,
    pub source_retrieval_example_storage_write_admission_hash: u64,
    pub source_retrieval_example_storage_write_approval_hash: u64,
    pub source_retrieval_example_storage_write_preflight_hash: u64,
    pub source_retrieval_example_storage_commit_intent_hash: u64,
    pub source_retrieval_example_materialization_plan_hash: u64,
    ...
    pub student_training_performed: bool,
    pub external_result_evidence_present: bool,
    pub storage_write_commit_intent_policy_reuse_examples: usize,
    pub storage_write_commit_intent_llm_fallback_examples: usize,
    pub retrieval_example_storage_write_commit_intent_ready: bool,
    pub retrieval_example_storage_write_commit_intent_status: &'static str,
    pub not_ready_reason: &'static str,
    pub retrieval_example_storage_write_commit_intent_hash: u64,
    pub receipt_hash: u64,
}

impl PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteCommitIntentReceipt {
    pub fn passed(&self) -> bool {
        self.is_valid()
            && self.retrieval_example_storage_write_commit_intent_ready
            && self.retrieval_example_storage_write_commit_intent_status
                == "retrieval_example_storage_write_commit_intent_ready"
    }

    pub fn is_valid(&self) -> bool {
        self.schema
            == "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_v1"
            && matches!(
                self.record_type,
                "policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent"
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_COMMIT_INTENT_SMOKE_STEP
                    | POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_COMMIT_INTENT_REGRESSION_SMOKE_STEP
            )
            && self.retrieval_example_learning_storage_write_commit_intent_version == 1
            && self.source_retrieval_example_storage_write_admission_hash != 0
            && self.source_retrieval_example_storage_write_approval_hash != 0
            && self.source_retrieval_example_storage_write_preflight_hash != 0
            && self.source_retrieval_example_storage_commit_intent_hash != 0
            && self.source_retrieval_example_materialization_plan_hash != 0
            ...
            && !self.batch_execution_performed
            && !self.student_training_performed
            && self.storage_write_commit_intent_policy_reuse_examples > 0
            && matches!(
                self.retrieval_example_storage_write_commit_intent_status,
                "retrieval_example_storage_write_commit_intent_ready"
            ...
            && matches!(
                self.not_ready_reason,
                "none" | "retrieval_example_storage_write_not_admitted"
            )
            && self.retrieval_example_storage_write_commit_intent_ready
                == (self.retrieval_example_storage_write_admitted
                    && self.retrieval_example_storage_write_approved
            ...
            && (self.retrieval_example_storage_write_commit_intent_status
                == "retrieval_example_storage_write_commit_intent_ready")
                == self.retrieval_example_storage_write_commit_intent_ready
            && self.retrieval_example_storage_write_commit_intent_hash != 0
            && self.receipt_hash != 0
            && self.retrieval_example_storage_write_commit_intent_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_hash(self)
            && self.receipt_hash
                == policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_receipt_hash(self)
    }

    pub fn to_json(&self) -> String {
        format!(
            r#"{{\"schema\":\"{}\",\"record_type\":\"{}\",\"retrieval_example_learning_storage_write_commit_intent_version\":{},\"source_retrieval_example_storage_write_admission_hash\":{},\"source_retrieval_example_storage_write_approval_hash\":{},\"source_retrieval_example_storage_write_preflight_hash\":{},\"source_retrieval_example_storage_commit_intent_hash\":{},\"source_retrieval_example_materialization_plan_hash\":{},\"source_retrieval_example_learning_admission_hash\":{},\"source_retrieval_example_learning_eligibility_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_admission_hash\":{},\"source_retrieval_result_use_summary_manifest_approval_hash\":{},\"source_retrieval_result_use_summary_manifest_readiness_hash\":{},\"source_retrieval_result_use_summary_manifest_admission_hash\":{},\"retrieval_example_storage_write_admitted\":{},\"retrieval_example_storage_write_approved\":{},\"retrieval_example_storage_write_preflight_ready\":{},\"retrieval_example_storage_commit_intent_ready\":{},\"retrieval_example_storage_admitted\":{},\"retrieval_example_materialization_plan_ready\":{},\"retrieval_example_learning_admitted\":{},\"retrieval_example_learning_eligible\":{},\"retrieval_result_use_summary_manifest_approval_admission_consumed\":{},\"retrieval_result_use_summary_manifest_approval_admitted\":{},\"retrieval_result_use_summary_manifest_approved\":{},\"retrieval_result_use_summary_manifest_ready_for_use\":{},\"retrieval_result_use_summary_manifest_admitted\":{},\"retrieval_read_performed\":{},\"retrieval_write_performed\":{},\"retrieval_query_executed\":{},\"runtime_result_approval_performed\":{},\"policy_promotion_performed\":{},\"batch_execution_performed\":{},\"student_training_performed\":{},\"external_result_evidence_present\":{},\"storage_write_commit_intent_policy_reuse_examples\":{},\"storage_write_commit_intent_llm_fallback_examples\":{},\"retrieval_example_storage_write_commit_intent_ready\":{},\"retrieval_example_storage_write_commit_intent_status\":\"{}\",\"not_ready_reason\":\"{}\",\"retrieval_example_storage_write_commit_intent_hash\":{},\"receipt_hash\":{}}}"#,
            self.schema,
            self.record_type,
            self.retrieval_example_learning_storage_write_commit_intent_version,
            self.source_retrieval_example_storage_write_admission_hash,
            self.source_retrieval_example_storage_write_approval_hash,
            self.source_retrieval_example_storage_write_preflight_hash,
            self.source_retrieval_example_storage_commit_intent_hash,
            self.source_retrieval_example_materialization_plan_hash,
            ...
            self.student_training_performed,
            self.external_result_evidence_present,
            self.storage_write_commit_intent_policy_reuse_examples,
            self.storage_write_commit_intent_llm_fallback_examples,
            self.retrieval_example_storage_write_commit_intent_ready,
            self.retrieval_example_storage_write_commit_intent_status,
            self.not_ready_reason,
            self.retrieval_example_storage_write_commit_intent_hash,
...
pub fn policy_reuse_cost_catalog_smoke_receipt(
    ...
    policy_reuse_cost_catalog_smoke_receipt_from_counts(
        POLICY_REUSE_COST_CATALOG_SMOKE_STEP,
        6,
        4,
        4,
        6,
...
fn policy_reuse_cost_catalog_smoke_receipt_from_counts(
    record_type: &'static str,
    declared_step_count: usize,
    covered_step_count: usize,
    regression_mode_count: usize,
    source_count: usize,
    summary_complete: bool,
    regression_modes_complete: bool,
    ...
    let canonical = crate::capability::judgment::PolicyReuseCostCatalogReceipt::from_source_hashes(
        declared_step_count,
        covered_step_count,
        regression_mode_count,
        source_count,
        summary_complete,
        regression_modes_complete,
        missing_surface,
        source_policy_reuse_hash,
        source_scale_trace_hash,
        source_performance_cost_trend_hash,
    ...
    receipt.record_type = record_type;
    receipt.catalog_hash = canonical.catalog_hash;
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestAdmissionReceipt {
    let summary_manifest =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_smoke_receipt();
    let summary = policy_reuse_evidence_retrieval_result_use_summary_smoke_receipt();
    policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_from_sources(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_ADMISSION_SMOKE_STEP,
        &summary_manifest,
        &summary,
        false,
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestAdmissionReceipt {
    let summary_manifest =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_from_sources(
    ...
    let retrieval_result_use_summary_manifest_ready = summary_manifest.passed();
    let retrieval_result_use_summary_ready = summary.passed();
    let external_result_evidence_present = summary_manifest.external_result_evidence_present
        && summary.external_result_evidence_present;
    let summary_manifest_admission_policy_reuse_examples =
        summary_manifest.summary_manifest_policy_reuse_examples;
    let summary_manifest_admission_llm_fallback_examples =
        summary_manifest.summary_manifest_llm_fallback_examples;
    let retrieval_result_use_summary_manifest_admitted = retrieval_result_use_summary_manifest_ready
        && retrieval_result_use_summary_ready
        && external_result_evidence_present
        && !retrieval_read_performed
        && !retrieval_write_performed
        ...
        && !policy_promotion_performed
        && !student_training_performed
        && summary_manifest_admission_policy_reuse_examples > 0
        && not_admitted_reason == "none";
    let result_use_summary_manifest_admission_status =
        if retrieval_result_use_summary_manifest_admitted {
            "result_use_summary_manifest_admitted"
        } else {
            "result_use_summary_manifest_not_admitted"
        };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestAdmissionReceipt {
        schema: "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_v1",
        record_type,
        retrieval_result_use_summary_manifest_admission_version: 1,
        source_retrieval_result_use_summary_manifest_hash: summary_manifest.receipt_hash,
        source_retrieval_result_use_summary_hash: summary.receipt_hash,
        retrieval_result_use_summary_manifest_ready,
        retrieval_result_use_summary_ready,
        retrieval_read_performed,
        ...
        student_training_performed,
        external_result_evidence_present,
        summary_manifest_admission_policy_reuse_examples,
        summary_manifest_admission_llm_fallback_examples,
        retrieval_result_use_summary_manifest_admitted,
        result_use_summary_manifest_admission_status,
        not_admitted_reason,
        result_use_summary_manifest_admission_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_admission(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_admission(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestAdmissionReceipt,
) {
    receipt.result_use_summary_manifest_admission_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_hash(receipt);
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_receipt_hash(receipt);
}

pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_smoke_receipt(
    ...
    let summary_manifest =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_smoke_receipt();
    policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_from_sources(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_READINESS_SMOKE_STEP,
        &admission,
        &summary_manifest,
        false,
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestReadinessReceipt {
    let admission =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_from_sources(
    ...
    let retrieval_result_use_summary_manifest_admitted = admission.passed();
    let retrieval_result_use_summary_manifest_ready = summary_manifest.passed();
    let external_result_evidence_present = admission.external_result_evidence_present
        && summary_manifest.external_result_evidence_present;
    let summary_manifest_readiness_policy_reuse_examples =
        admission.summary_manifest_admission_policy_reuse_examples;
    let summary_manifest_readiness_llm_fallback_examples =
        admission.summary_manifest_admission_llm_fallback_examples;
    let retrieval_result_use_summary_manifest_ready_for_use =
        retrieval_result_use_summary_manifest_admitted
            ...
            && !policy_promotion_performed
            && !student_training_performed
            && summary_manifest_readiness_policy_reuse_examples > 0
            && not_ready_reason == "none";
    let result_use_summary_manifest_readiness_status =
        if retrieval_result_use_summary_manifest_ready_for_use {
            "result_use_summary_manifest_ready_for_use"
        } else {
            "result_use_summary_manifest_not_ready_for_use"
        };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestReadinessReceipt {
        schema: "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_v1",
        record_type,
        retrieval_result_use_summary_manifest_readiness_version: 1,
        ...
        not_ready_reason,
        result_use_summary_manifest_readiness_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestReadinessReceipt,
) {
    receipt.result_use_summary_manifest_readiness_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_hash(receipt);
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_receipt_hash(receipt);
}

pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_smoke_receipt(
    ...
    let admission =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke_receipt();
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_from_sources(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_SMOKE_STEP,
        &readiness,
        &admission,
        false,
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalReceipt {
    let readiness =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_from_sources(
    ...
    let retrieval_result_use_summary_manifest_ready_for_use = readiness.passed();
    let retrieval_result_use_summary_manifest_admitted = admission.passed();
    let external_result_evidence_present =
        readiness.external_result_evidence_present && admission.external_result_evidence_present;
    let summary_manifest_approval_policy_reuse_examples =
        readiness.summary_manifest_readiness_policy_reuse_examples;
    let summary_manifest_approval_llm_fallback_examples =
    ...
    let retrieval_result_use_summary_manifest_approved =
        retrieval_result_use_summary_manifest_ready_for_use
            ...
            && !policy_promotion_performed
            && !student_training_performed
            && summary_manifest_approval_policy_reuse_examples > 0
            && not_approved_reason == "none";
    let result_use_summary_manifest_approval_status =
        if retrieval_result_use_summary_manifest_approved {
            "result_use_summary_manifest_approved"
        } else {
            "result_use_summary_manifest_not_approved"
        };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalReceipt {
        ...
        not_approved_reason,
        result_use_summary_manifest_approval_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalReceipt,
) {
    receipt.result_use_summary_manifest_approval_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_hash(receipt);
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_receipt_hash(receipt);
}

pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke_receipt(
    ...
    let admission =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_smoke_receipt();
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_from_sources(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_SMOKE_STEP,
        &approval,
        &readiness,
        &admission,
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionReceipt {
    let approval =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_from_sources(
    ...
    let retrieval_result_use_summary_manifest_approved = approval.passed();
    let retrieval_result_use_summary_manifest_ready_for_use = readiness.passed();
    let retrieval_result_use_summary_manifest_admitted = admission.passed();
    let external_result_evidence_present = approval.external_result_evidence_present
        && readiness.external_result_evidence_present
        && admission.external_result_evidence_present;
    let summary_manifest_approval_admission_policy_reuse_examples =
        approval.summary_manifest_approval_policy_reuse_examples;
    let summary_manifest_approval_admission_llm_fallback_examples =
        approval.summary_manifest_approval_llm_fallback_examples;
    let retrieval_result_use_summary_manifest_approval_admitted =
        retrieval_result_use_summary_manifest_approved
            ...
            && !policy_promotion_performed
            && !student_training_performed
            && summary_manifest_approval_admission_policy_reuse_examples > 0
            && not_admitted_reason == "none";
    let result_use_summary_manifest_approval_admission_status =
        if retrieval_result_use_summary_manifest_approval_admitted {
            "result_use_summary_manifest_approval_admitted"
        } else {
            "result_use_summary_manifest_approval_not_admitted"
        };
...
fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionReceipt,
) {
    receipt.result_use_summary_manifest_approval_admission_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_hash(
            receipt,
        );
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_receipt_hash(
            receipt,
        );
}

pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionReceipt {
    let approval_admission =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_smoke_receipt();
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_from_source(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_SMOKE_STEP,
        &approval_admission,
        false,
        false,
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionReceipt {
    let approval_admission =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_from_source(
    ...
    student_training_performed: bool,
    not_consumed_reason: &'static str,
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionReceipt {
    let retrieval_result_use_summary_manifest_approval_admitted = approval_admission.passed();
    let retrieval_result_use_summary_manifest_approved =
        approval_admission.retrieval_result_use_summary_manifest_approved;
    let retrieval_result_use_summary_manifest_ready_for_use =
        approval_admission.retrieval_result_use_summary_manifest_ready_for_use;
    let retrieval_result_use_summary_manifest_admitted =
        approval_admission.retrieval_result_use_summary_manifest_admitted;
    let external_result_evidence_present = approval_admission.external_result_evidence_present;
    let summary_manifest_approval_admission_consumption_policy_reuse_examples =
        approval_admission.summary_manifest_approval_admission_policy_reuse_examples;
    let summary_manifest_approval_admission_consumption_llm_fallback_examples =
        approval_admission.summary_manifest_approval_admission_llm_fallback_examples;
    let retrieval_result_use_summary_manifest_approval_admission_consumed =
        retrieval_result_use_summary_manifest_approval_admitted
            && retrieval_result_use_summary_manifest_approved
            && retrieval_result_use_summary_manifest_ready_for_use
            && retrieval_result_use_summary_manifest_admitted
            ...
            && !student_training_performed
            && summary_manifest_approval_admission_consumption_policy_reuse_examples > 0
            && not_consumed_reason == "none";
    let result_use_summary_manifest_approval_admission_consumption_status =
        if retrieval_result_use_summary_manifest_approval_admission_consumed {
            "result_use_summary_manifest_approval_admission_consumed"
        } else {
            "result_use_summary_manifest_approval_admission_not_consumed"
        };
...
fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionReceipt,
) {
    receipt.result_use_summary_manifest_approval_admission_consumption_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_hash(
            receipt,
        );
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_receipt_hash(
            receipt,
        );
}
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_smoke_receipt(
    ...
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_from_source(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_ADMISSION_SMOKE_STEP,
        &eligibility,
        false,
        false,
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningAdmissionReceipt{
    let eligibility =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_from_source(
    ...
    let retrieval_example_learning_eligible = eligibility.passed();
    let retrieval_result_use_summary_manifest_approval_admission_consumed =
        eligibility.retrieval_result_use_summary_manifest_approval_admission_consumed;
    let retrieval_result_use_summary_manifest_approval_admitted =
        eligibility.retrieval_result_use_summary_manifest_approval_admitted;
    let retrieval_result_use_summary_manifest_approved =
        eligibility.retrieval_result_use_summary_manifest_approved;
    let retrieval_result_use_summary_manifest_ready_for_use =
        eligibility.retrieval_result_use_summary_manifest_ready_for_use;
    let retrieval_result_use_summary_manifest_admitted =
        eligibility.retrieval_result_use_summary_manifest_admitted;
    let external_result_evidence_present = eligibility.external_result_evidence_present;
    let retrieval_example_learning_admission_policy_reuse_examples =
        eligibility.retrieval_example_learning_eligibility_policy_reuse_examples;
    let retrieval_example_learning_admission_llm_fallback_examples =
        eligibility.retrieval_example_learning_eligibility_llm_fallback_examples;
    let retrieval_example_learning_admitted = retrieval_example_learning_eligible
        && retrieval_result_use_summary_manifest_approval_admission_consumed
        && retrieval_result_use_summary_manifest_approval_admitted
        && retrieval_result_use_summary_manifest_approved
        && retrieval_result_use_summary_manifest_ready_for_use
        ...
        && !batch_execution_performed
        && !student_training_performed
        && retrieval_example_learning_admission_policy_reuse_examples > 0
        && not_admitted_reason == "none";
    let retrieval_example_learning_admission_status = if retrieval_example_learning_admitted {
        "retrieval_example_learning_admitted"
    } else {
        "retrieval_example_learning_not_admitted"
    };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningAdmissionReceipt {
        schema: "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_v1",
        record_type,
        retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_version: 1,
        source_retrieval_example_learning_eligibility_hash: eligibility.receipt_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash: eligibility
            .source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_hash: eligibility
            .source_retrieval_result_use_summary_manifest_approval_admission_hash,
        source_retrieval_result_use_summary_manifest_approval_hash: eligibility
            .source_retrieval_result_use_summary_manifest_approval_hash,
        source_retrieval_result_use_summary_manifest_readiness_hash: eligibility
            .source_retrieval_result_use_summary_manifest_readiness_hash,
        source_retrieval_result_use_summary_manifest_admission_hash: eligibility
            .source_retrieval_result_use_summary_manifest_admission_hash,
        retrieval_example_learning_eligible,
        retrieval_result_use_summary_manifest_approval_admission_consumed,
        retrieval_result_use_summary_manifest_approval_admitted,
        ...
        student_training_performed,
        external_result_evidence_present,
        retrieval_example_learning_admission_policy_reuse_examples,
        retrieval_example_learning_admission_llm_fallback_examples,
        retrieval_example_learning_admitted,
        retrieval_example_learning_admission_status,
        not_admitted_reason,
        retrieval_example_learning_admission_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningAdmissionReceipt,
) {
    receipt.retrieval_example_learning_admission_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_hash(
            receipt,
        );
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_receipt_hash(
            receipt,
        );
}


pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_smoke_receipt(
    ...
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_from_source(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_MATERIALIZATION_PLAN_SMOKE_STEP,
        &admission,
        false,
        false,
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningMaterializationPlanReceipt{
    let admission =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_from_source(
    ...
    let retrieval_example_learning_admitted = admission.passed();
    let retrieval_example_learning_eligible = admission.retrieval_example_learning_eligible;
    let retrieval_result_use_summary_manifest_approval_admission_consumed =
    ...
    let external_result_evidence_present = admission.external_result_evidence_present;
    let materialization_plan_policy_reuse_examples =
        admission.retrieval_example_learning_admission_policy_reuse_examples;
    let materialization_plan_llm_fallback_examples =
        admission.retrieval_example_learning_admission_llm_fallback_examples;
    let retrieval_example_materialization_plan_ready = retrieval_example_learning_admitted
        && retrieval_example_learning_eligible
        && retrieval_result_use_summary_manifest_approval_admission_consumed
        && retrieval_result_use_summary_manifest_approval_admitted
        && retrieval_result_use_summary_manifest_approved
        ...
        && !batch_execution_performed
        && !student_training_performed
        && materialization_plan_policy_reuse_examples > 0
        && not_ready_reason == "none";
    let retrieval_example_materialization_plan_status =
        if retrieval_example_materialization_plan_ready {
            "retrieval_example_materialization_plan_ready"
        } else {
            "retrieval_example_materialization_plan_not_ready"
        };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningMaterializationPlanReceipt {
        schema: "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_v1",
        record_type,
        retrieval_example_learning_materialization_plan_version: 1,
        source_retrieval_example_learning_admission_hash: admission.receipt_hash,
        source_retrieval_example_learning_eligibility_hash: admission.source_retrieval_example_learning_eligibility_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash: admission
            .source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_hash: admission
            .source_retrieval_result_use_summary_manifest_approval_admission_hash,
        source_retrieval_result_use_summary_manifest_approval_hash: admission
            .source_retrieval_result_use_summary_manifest_approval_hash,
        source_retrieval_result_use_summary_manifest_readiness_hash: admission
            .source_retrieval_result_use_summary_manifest_readiness_hash,
        source_retrieval_result_use_summary_manifest_admission_hash: admission
            .source_retrieval_result_use_summary_manifest_admission_hash,
        retrieval_example_learning_admitted,
        retrieval_example_learning_eligible,
        retrieval_result_use_summary_manifest_approval_admission_consumed,
        ...
        student_training_performed,
        external_result_evidence_present,
        materialization_plan_policy_reuse_examples,
        materialization_plan_llm_fallback_examples,
        retrieval_example_materialization_plan_ready,
        retrieval_example_materialization_plan_status,
        not_ready_reason,
        retrieval_example_materialization_plan_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningMaterializationPlanReceipt,
) {
    receipt.retrieval_example_materialization_plan_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_hash(
            receipt,
        );
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_receipt_hash(
            receipt,
        );
}


pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_smoke_receipt(
    ...
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_from_source(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_ADMISSION_SMOKE_STEP,
        &plan,
        false,
        false,
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageAdmissionReceipt{
    let plan =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_from_source(
    ...
    let retrieval_example_materialization_plan_ready = plan.passed();
    let retrieval_example_learning_admitted = plan.retrieval_example_learning_admitted;
    let retrieval_example_learning_eligible = plan.retrieval_example_learning_eligible;
    let retrieval_result_use_summary_manifest_approval_admission_consumed =
        plan.retrieval_result_use_summary_manifest_approval_admission_consumed;
    let retrieval_result_use_summary_manifest_approval_admitted =
        plan.retrieval_result_use_summary_manifest_approval_admitted;
    let retrieval_result_use_summary_manifest_approved =
        plan.retrieval_result_use_summary_manifest_approved;
    let retrieval_result_use_summary_manifest_ready_for_use =
        plan.retrieval_result_use_summary_manifest_ready_for_use;
    let retrieval_result_use_summary_manifest_admitted =
        plan.retrieval_result_use_summary_manifest_admitted;
    let external_result_evidence_present = plan.external_result_evidence_present;
    let storage_admission_policy_reuse_examples = plan.materialization_plan_policy_reuse_examples;
    let storage_admission_llm_fallback_examples = plan.materialization_plan_llm_fallback_examples;
    let retrieval_example_storage_admitted = retrieval_example_materialization_plan_ready
        && retrieval_example_learning_admitted
        && retrieval_example_learning_eligible
        && retrieval_result_use_summary_manifest_approval_admission_consumed
        && retrieval_result_use_summary_manifest_approval_admitted
        ...
        && !batch_execution_performed
        && !student_training_performed
        && storage_admission_policy_reuse_examples > 0
        && not_admitted_reason == "none";
    let retrieval_example_storage_admission_status = if retrieval_example_storage_admitted {
        "retrieval_example_storage_admitted"
    } else {
        "retrieval_example_storage_not_admitted"
    };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageAdmissionReceipt {
        schema: "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_v1",
        record_type,
        retrieval_example_learning_storage_admission_version: 1,
        source_retrieval_example_materialization_plan_hash: plan.receipt_hash,
        source_retrieval_example_learning_admission_hash: plan.source_retrieval_example_learning_admission_hash,
        source_retrieval_example_learning_eligibility_hash: plan.source_retrieval_example_learning_eligibility_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash: plan.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_hash: plan.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        source_retrieval_result_use_summary_manifest_approval_hash: plan.source_retrieval_result_use_summary_manifest_approval_hash,
        source_retrieval_result_use_summary_manifest_readiness_hash: plan.source_retrieval_result_use_summary_manifest_readiness_hash,
        source_retrieval_result_use_summary_manifest_admission_hash: plan.source_retrieval_result_use_summary_manifest_admission_hash,
        retrieval_example_materialization_plan_ready,
        retrieval_example_learning_admitted,
        retrieval_example_learning_eligible,
        retrieval_result_use_summary_manifest_approval_admission_consumed,
        ...
        student_training_performed,
        external_result_evidence_present,
        storage_admission_policy_reuse_examples,
        storage_admission_llm_fallback_examples,
        retrieval_example_storage_admitted,
        retrieval_example_storage_admission_status,
        not_admitted_reason,
        retrieval_example_storage_admission_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageAdmissionReceipt,
) {
    receipt.retrieval_example_storage_admission_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_hash(
            receipt,
        );
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_receipt_hash(
            receipt,
        );
}
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_smoke_receipt(
    ...
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_from_source(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_PREFLIGHT_SMOKE_STEP,
        &intent,
        "none",
    )
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWritePreflightReceipt{
    let intent =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_from_source(
    record_type: &'static str,
    intent: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageCommitIntentReceipt,
    not_ready_reason: &'static str,
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWritePreflightReceipt{
    let retrieval_example_storage_commit_intent_ready = intent.passed();
    let storage_write_preflight_policy_reuse_examples =
        intent.storage_commit_intent_policy_reuse_examples;
    let storage_write_preflight_llm_fallback_examples =
        intent.storage_commit_intent_llm_fallback_examples;
    let retrieval_example_storage_write_preflight_ready =
        retrieval_example_storage_commit_intent_ready
            && intent.retrieval_example_storage_admitted
            && intent.retrieval_example_materialization_plan_ready
            && intent.retrieval_example_learning_admitted
            && intent.retrieval_example_learning_eligible
            && intent.retrieval_result_use_summary_manifest_approval_admission_consumed
            && intent.retrieval_result_use_summary_manifest_approval_admitted
            && intent.retrieval_result_use_summary_manifest_approved
            && intent.retrieval_result_use_summary_manifest_ready_for_use
            && intent.retrieval_result_use_summary_manifest_admitted
            && intent.external_result_evidence_present
            && !intent.retrieval_read_performed
            && !intent.retrieval_write_performed
            && !intent.retrieval_query_executed
            && !intent.runtime_result_approval_performed
            && !intent.policy_promotion_performed
            && !intent.batch_execution_performed
            && !intent.student_training_performed
            && storage_write_preflight_policy_reuse_examples > 0
            && not_ready_reason == "none";
    let retrieval_example_storage_write_preflight_status =
        if retrieval_example_storage_write_preflight_ready {
            "retrieval_example_storage_write_preflight_ready"
        } else {
            "retrieval_example_storage_write_preflight_not_ready"
        };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWritePreflightReceipt {
        schema: "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_v1",
        record_type,
        retrieval_example_learning_storage_write_preflight_version: 1,
        source_retrieval_example_storage_commit_intent_hash: intent.receipt_hash,
        source_retrieval_example_materialization_plan_hash: intent.source_retrieval_example_materialization_plan_hash,
        source_retrieval_example_learning_admission_hash: intent.source_retrieval_example_learning_admission_hash,
        source_retrieval_example_learning_eligibility_hash: intent.source_retrieval_example_learning_eligibility_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash: intent.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_hash: intent.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        source_retrieval_result_use_summary_manifest_approval_hash: intent.source_retrieval_result_use_summary_manifest_approval_hash,
        source_retrieval_result_use_summary_manifest_readiness_hash: intent.source_retrieval_result_use_summary_manifest_readiness_hash,
        source_retrieval_result_use_summary_manifest_admission_hash: intent.source_retrieval_result_use_summary_manifest_admission_hash,
        retrieval_example_storage_commit_intent_ready,
        retrieval_example_storage_admitted: intent.retrieval_example_storage_admitted,
        retrieval_example_materialization_plan_ready: intent.retrieval_example_materialization_plan_ready,
        retrieval_example_learning_admitted: intent.retrieval_example_learning_admitted,
        retrieval_example_learning_eligible: intent.retrieval_example_learning_eligible,
        retrieval_result_use_summary_manifest_approval_admission_consumed: intent.retrieval_result_use_summary_manifest_approval_admission_consumed,
        retrieval_result_use_summary_manifest_approval_admitted: intent.retrieval_result_use_summary_manifest_approval_admitted,
        retrieval_result_use_summary_manifest_approved: intent.retrieval_result_use_summary_manifest_approved,
        retrieval_result_use_summary_manifest_ready_for_use: intent.retrieval_result_use_summary_manifest_ready_for_use,
        retrieval_result_use_summary_manifest_admitted: intent.retrieval_result_use_summary_manifest_admitted,
        retrieval_read_performed: intent.retrieval_read_performed,
        retrieval_write_performed: intent.retrieval_write_performed,
        retrieval_query_executed: intent.retrieval_query_executed,
        runtime_result_approval_performed: intent.runtime_result_approval_performed,
        policy_promotion_performed: intent.policy_promotion_performed,
        batch_execution_performed: intent.batch_execution_performed,
        student_training_performed: intent.student_training_performed,
        external_result_evidence_present: intent.external_result_evidence_present,
        storage_write_preflight_policy_reuse_examples,
        storage_write_preflight_llm_fallback_examples,
        retrieval_example_storage_write_preflight_ready,
        retrieval_example_storage_write_preflight_status,
        not_ready_reason,
        retrieval_example_storage_write_preflight_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWritePreflightReceipt,
) {
    receipt.retrieval_example_storage_write_preflight_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_hash(
            receipt,
        );
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_receipt_hash(
            receipt,
        );
}

pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_smoke_receipt(
    ...
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_from_source(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_APPROVAL_SMOKE_STEP,
        &preflight,
        "none",
    )
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteApprovalReceipt{
    let preflight =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_from_source(
    record_type: &'static str,
    preflight: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWritePreflightReceipt,
    not_approved_reason: &'static str,
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteApprovalReceipt{
    let retrieval_example_storage_write_preflight_ready = preflight.passed();
    let storage_write_approval_policy_reuse_examples =
        preflight.storage_write_preflight_policy_reuse_examples;
    let storage_write_approval_llm_fallback_examples =
        preflight.storage_write_preflight_llm_fallback_examples;
    let retrieval_example_storage_write_approved = retrieval_example_storage_write_preflight_ready
        && preflight.retrieval_example_storage_commit_intent_ready
        && preflight.retrieval_example_storage_admitted
        && preflight.retrieval_example_materialization_plan_ready
        && preflight.retrieval_example_learning_admitted
        && preflight.retrieval_example_learning_eligible
        && preflight.retrieval_result_use_summary_manifest_approval_admission_consumed
        && preflight.retrieval_result_use_summary_manifest_approval_admitted
        && preflight.retrieval_result_use_summary_manifest_approved
        && preflight.retrieval_result_use_summary_manifest_ready_for_use
        && preflight.retrieval_result_use_summary_manifest_admitted
        && preflight.external_result_evidence_present
        && !preflight.retrieval_read_performed
        && !preflight.retrieval_write_performed
        && !preflight.retrieval_query_executed
        && !preflight.runtime_result_approval_performed
        && !preflight.policy_promotion_performed
        && !preflight.batch_execution_performed
        && !preflight.student_training_performed
        && storage_write_approval_policy_reuse_examples > 0
        && not_approved_reason == "none";
    let retrieval_example_storage_write_approval_status =
        if retrieval_example_storage_write_approved {
            "retrieval_example_storage_write_approved"
        } else {
            "retrieval_example_storage_write_not_approved"
        };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteApprovalReceipt {
        ...
        source_retrieval_example_storage_write_preflight_hash: preflight.receipt_hash,
        source_retrieval_example_storage_commit_intent_hash: preflight.source_retrieval_example_storage_commit_intent_hash,
        source_retrieval_example_materialization_plan_hash: preflight.source_retrieval_example_materialization_plan_hash,
        source_retrieval_example_learning_admission_hash: preflight.source_retrieval_example_learning_admission_hash,
        source_retrieval_example_learning_eligibility_hash: preflight.source_retrieval_example_learning_eligibility_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash: preflight.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_hash: preflight.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        source_retrieval_result_use_summary_manifest_approval_hash: preflight.source_retrieval_result_use_summary_manifest_approval_hash,
        source_retrieval_result_use_summary_manifest_readiness_hash: preflight.source_retrieval_result_use_summary_manifest_readiness_hash,
        source_retrieval_result_use_summary_manifest_admission_hash: preflight.source_retrieval_result_use_summary_manifest_admission_hash,
        retrieval_example_storage_write_preflight_ready,
        retrieval_example_storage_commit_intent_ready: preflight.retrieval_example_storage_commit_intent_ready,
        retrieval_example_storage_admitted: preflight.retrieval_example_storage_admitted,
        retrieval_example_materialization_plan_ready: preflight.retrieval_example_materialization_plan_ready,
        retrieval_example_learning_admitted: preflight.retrieval_example_learning_admitted,
        retrieval_example_learning_eligible: preflight.retrieval_example_learning_eligible,
        retrieval_result_use_summary_manifest_approval_admission_consumed: preflight.retrieval_result_use_summary_manifest_approval_admission_consumed,
        retrieval_result_use_summary_manifest_approval_admitted: preflight.retrieval_result_use_summary_manifest_approval_admitted,
        retrieval_result_use_summary_manifest_approved: preflight.retrieval_result_use_summary_manifest_approved,
        retrieval_result_use_summary_manifest_ready_for_use: preflight.retrieval_result_use_summary_manifest_ready_for_use,
        retrieval_result_use_summary_manifest_admitted: preflight.retrieval_result_use_summary_manifest_admitted,
        retrieval_read_performed: preflight.retrieval_read_performed,
        retrieval_write_performed: preflight.retrieval_write_performed,
        retrieval_query_executed: preflight.retrieval_query_executed,
        runtime_result_approval_performed: preflight.runtime_result_approval_performed,
        policy_promotion_performed: preflight.policy_promotion_performed,
        batch_execution_performed: preflight.batch_execution_performed,
        student_training_performed: preflight.student_training_performed,
        external_result_evidence_present: preflight.external_result_evidence_present,
        storage_write_approval_policy_reuse_examples,
        storage_write_approval_llm_fallback_examples,
        retrieval_example_storage_write_approved,
        retrieval_example_storage_write_approval_status,
        not_approved_reason,
        retrieval_example_storage_write_approval_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteApprovalReceipt,
) {
    receipt.retrieval_example_storage_write_approval_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_hash(
            receipt,
        );
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_receipt_hash(
            receipt,
        );
}

pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_smoke_receipt(
    ...
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_from_source(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_ADMISSION_SMOKE_STEP,
        &approval,
        "none",
    )
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteAdmissionReceipt{
    let approval =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_from_source(
    record_type: &'static str,
    approval: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteApprovalReceipt,
    not_admitted_reason: &'static str,
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteAdmissionReceipt{
    let retrieval_example_storage_write_approved = approval.passed();
    let storage_write_admission_policy_reuse_examples =
        approval.storage_write_approval_policy_reuse_examples;
    let storage_write_admission_llm_fallback_examples =
        approval.storage_write_approval_llm_fallback_examples;
    let retrieval_example_storage_write_admitted = retrieval_example_storage_write_approved
        && approval.retrieval_example_storage_write_preflight_ready
        && approval.retrieval_example_storage_commit_intent_ready
        && approval.retrieval_example_storage_admitted
        && approval.retrieval_example_materialization_plan_ready
        && approval.retrieval_example_learning_admitted
        && approval.retrieval_example_learning_eligible
        && approval.retrieval_result_use_summary_manifest_approval_admission_consumed
        && approval.retrieval_result_use_summary_manifest_approval_admitted
        && approval.retrieval_result_use_summary_manifest_approved
        && approval.retrieval_result_use_summary_manifest_ready_for_use
        && approval.retrieval_result_use_summary_manifest_admitted
        && approval.external_result_evidence_present
        && !approval.retrieval_read_performed
        && !approval.retrieval_write_performed
        && !approval.retrieval_query_executed
        && !approval.runtime_result_approval_performed
        && !approval.policy_promotion_performed
        && !approval.batch_execution_performed
        && !approval.student_training_performed
        && storage_write_admission_policy_reuse_examples > 0
        && not_admitted_reason == "none";
    let retrieval_example_storage_write_admission_status =
        if retrieval_example_storage_write_admitted {
            "retrieval_example_storage_write_admitted"
        } else {
            "retrieval_example_storage_write_not_admitted"
        };
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteAdmissionReceipt {
        schema: "canon_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_v1",
        record_type,
        retrieval_example_learning_storage_write_admission_version: 1,
        source_retrieval_example_storage_write_approval_hash: approval.receipt_hash,
        source_retrieval_example_storage_write_preflight_hash: approval.source_retrieval_example_storage_write_preflight_hash,
        source_retrieval_example_storage_commit_intent_hash: approval.source_retrieval_example_storage_commit_intent_hash,
        source_retrieval_example_materialization_plan_hash: approval.source_retrieval_example_materialization_plan_hash,
        source_retrieval_example_learning_admission_hash: approval.source_retrieval_example_learning_admission_hash,
        source_retrieval_example_learning_eligibility_hash: approval.source_retrieval_example_learning_eligibility_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash: approval.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_hash: approval.source_retrieval_result_use_summary_manifest_approval_admission_hash,
        source_retrieval_result_use_summary_manifest_approval_hash: approval.source_retrieval_result_use_summary_manifest_approval_hash,
        source_retrieval_result_use_summary_manifest_readiness_hash: approval.source_retrieval_result_use_summary_manifest_readiness_hash,
        source_retrieval_result_use_summary_manifest_admission_hash: approval.source_retrieval_result_use_summary_manifest_admission_hash,
        retrieval_example_storage_write_approved,
        retrieval_example_storage_write_preflight_ready: approval.retrieval_example_storage_write_preflight_ready,
        retrieval_example_storage_commit_intent_ready: approval.retrieval_example_storage_commit_intent_ready,
        retrieval_example_storage_admitted: approval.retrieval_example_storage_admitted,
        retrieval_example_materialization_plan_ready: approval.retrieval_example_materialization_plan_ready,
        retrieval_example_learning_admitted: approval.retrieval_example_learning_admitted,
        retrieval_example_learning_eligible: approval.retrieval_example_learning_eligible,
        retrieval_result_use_summary_manifest_approval_admission_consumed: approval.retrieval_result_use_summary_manifest_approval_admission_consumed,
        retrieval_result_use_summary_manifest_approval_admitted: approval.retrieval_result_use_summary_manifest_approval_admitted,
        retrieval_result_use_summary_manifest_approved: approval.retrieval_result_use_summary_manifest_approved,
        retrieval_result_use_summary_manifest_ready_for_use: approval.retrieval_result_use_summary_manifest_ready_for_use,
        retrieval_result_use_summary_manifest_admitted: approval.retrieval_result_use_summary_manifest_admitted,
        retrieval_read_performed: approval.retrieval_read_performed,
        retrieval_write_performed: approval.retrieval_write_performed,
        retrieval_query_executed: approval.retrieval_query_executed,
        runtime_result_approval_performed: approval.runtime_result_approval_performed,
        policy_promotion_performed: approval.policy_promotion_performed,
        batch_execution_performed: approval.batch_execution_performed,
        student_training_performed: approval.student_training_performed,
        external_result_evidence_present: approval.external_result_evidence_present,
        storage_write_admission_policy_reuse_examples,
        storage_write_admission_llm_fallback_examples,
        retrieval_example_storage_write_admitted,
        retrieval_example_storage_write_admission_status,
        not_admitted_reason,
        retrieval_example_storage_write_admission_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteAdmissionReceipt,
) {
    receipt.retrieval_example_storage_write_admission_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_hash(
            receipt,
        );
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_receipt_hash(
            receipt,
        );
}

pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_smoke_receipt(
    ...
    policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_from_source(
        POLICY_REUSE_EVIDENCE_RETRIEVAL_RESULT_USE_SUMMARY_MANIFEST_APPROVAL_ADMISSION_CONSUMPTION_LEARNING_STORAGE_WRITE_COMMIT_INTENT_SMOKE_STEP,
        &admission,
        "none",
    )
...
pub fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_regression_smoke_receipt(
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteCommitIntentReceipt{
    let admission =
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_from_source(
    record_type: &'static str,
    admission: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteAdmissionReceipt,
    not_ready_reason: &'static str,
) -> PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteCommitIntentReceipt{
    let retrieval_example_storage_write_admitted = admission.passed();
    let storage_write_commit_intent_policy_reuse_examples =
    ...
    let mut receipt = PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteCommitIntentReceipt {
        ...
        record_type,
        retrieval_example_learning_storage_write_commit_intent_version: 1,
        source_retrieval_example_storage_write_admission_hash: admission.receipt_hash,
        source_retrieval_example_storage_write_approval_hash: admission.source_retrieval_example_storage_write_approval_hash,
        source_retrieval_example_storage_write_preflight_hash: admission.source_retrieval_example_storage_write_preflight_hash,
        source_retrieval_example_storage_commit_intent_hash: admission.source_retrieval_example_storage_commit_intent_hash,
        source_retrieval_example_materialization_plan_hash: admission.source_retrieval_example_materialization_plan_hash,
        source_retrieval_example_learning_admission_hash: admission.source_retrieval_example_learning_admission_hash,
        source_retrieval_example_learning_eligibility_hash: admission.source_retrieval_example_learning_eligibility_hash,
        source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash: admission.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash,
        ...
        source_retrieval_result_use_summary_manifest_admission_hash: admission.source_retrieval_result_use_summary_manifest_admission_hash,
        retrieval_example_storage_write_admitted,
        retrieval_example_storage_write_approved: admission.retrieval_example_storage_write_approved,
        retrieval_example_storage_write_preflight_ready: admission.retrieval_example_storage_write_preflight_ready,
        retrieval_example_storage_commit_intent_ready: admission.retrieval_example_storage_commit_intent_ready,
        retrieval_example_storage_admitted: admission.retrieval_example_storage_admitted,
        retrieval_example_materialization_plan_ready: admission.retrieval_example_materialization_plan_ready,
        retrieval_example_learning_admitted: admission.retrieval_example_learning_admitted,
        retrieval_example_learning_eligible: admission.retrieval_example_learning_eligible,
        retrieval_result_use_summary_manifest_approval_admission_consumed: admission.retrieval_result_use_summary_manifest_approval_admission_consumed,
        ...
        student_training_performed: admission.student_training_performed,
        external_result_evidence_present: admission.external_result_evidence_present,
        storage_write_commit_intent_policy_reuse_examples,
        storage_write_commit_intent_llm_fallback_examples,
        retrieval_example_storage_write_commit_intent_ready,
        retrieval_example_storage_write_commit_intent_status,
        not_ready_reason,
        retrieval_example_storage_write_commit_intent_hash: 0,
        receipt_hash: 0,
    };
    finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent(&mut receipt);
    receipt
}

fn finalize_policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent(
    receipt: &mut PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteCommitIntentReceipt,
) {
    ...
    receipt.receipt_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_receipt_hash(
            receipt,
        );
}
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestAdmissionReceipt,
) -> u64 {
    if receipt.retrieval_result_use_summary_manifest_admission_version == 0
        || receipt.source_retrieval_result_use_summary_manifest_hash == 0
        || receipt.source_retrieval_result_use_summary_hash == 0
    {
        return 0;
    }
    let result_use_summary_manifest_admission_status_code =
        match receipt.result_use_summary_manifest_admission_status {
            "result_use_summary_manifest_admitted" => 1,
            "result_use_summary_manifest_not_admitted" => 2,
            _ => 0,
        };
    let not_admitted_reason_code = match receipt.not_admitted_reason {
        "none" => 1,
        "summary_manifest_not_ready" => 2,
        "summary_not_ready" => 3,
        "missing_external_result_evidence" => 4,
        "retrieval_read_attempted" => 5,
        "retrieval_write_attempted" => 6,
    ...
    if result_use_summary_manifest_admission_status_code == 0 || not_admitted_reason_code == 0 {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_receipt_hash(
    ...
    let result_use_summary_manifest_admission_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_admission_hash(receipt);
    if result_use_summary_manifest_admission_hash == 0
        || receipt.result_use_summary_manifest_admission_hash
            != result_use_summary_manifest_admission_hash
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestReadinessReceipt,
) -> u64 {
    if receipt.retrieval_result_use_summary_manifest_readiness_version == 0
        || receipt.source_retrieval_result_use_summary_manifest_admission_hash == 0
        || receipt.source_retrieval_result_use_summary_manifest_hash == 0
    {
        return 0;
    }
    let result_use_summary_manifest_readiness_status_code =
        match receipt.result_use_summary_manifest_readiness_status {
            "result_use_summary_manifest_ready_for_use" => 1,
            "result_use_summary_manifest_not_ready_for_use" => 2,
            _ => 0,
        };
    let not_ready_reason_code = match receipt.not_ready_reason {
        "none" => 1,
        "summary_manifest_not_admitted" => 2,
        "summary_manifest_not_ready" => 3,
        "missing_external_result_evidence" => 4,
        "retrieval_read_attempted" => 5,
        "retrieval_write_attempted" => 6,
        "retrieval_query_executed" => 7,
    ...
    if result_use_summary_manifest_readiness_status_code == 0 || not_ready_reason_code == 0 {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_receipt_hash(
    ...
    let result_use_summary_manifest_readiness_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_readiness_hash(receipt);
    if result_use_summary_manifest_readiness_hash == 0
        || receipt.result_use_summary_manifest_readiness_hash
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalReceipt,
) -> u64 {
    if receipt.retrieval_result_use_summary_manifest_approval_version == 0
        || receipt.source_retrieval_result_use_summary_manifest_readiness_hash == 0
        || receipt.source_retrieval_result_use_summary_manifest_admission_hash == 0
    {
        return 0;
    }
    let result_use_summary_manifest_approval_status_code =
        match receipt.result_use_summary_manifest_approval_status {
            "result_use_summary_manifest_approved" => 1,
            "result_use_summary_manifest_not_approved" => 2,
            _ => 0,
        };
    let not_approved_reason_code = match receipt.not_approved_reason {
        "none" => 1,
        "summary_manifest_not_ready_for_use" => 2,
        "summary_manifest_not_admitted" => 3,
        "missing_external_result_evidence" => 4,
        "retrieval_read_attempted" => 5,
        "retrieval_write_attempted" => 6,
        "retrieval_query_executed" => 7,
    ...
    if result_use_summary_manifest_approval_status_code == 0 || not_approved_reason_code == 0 {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_receipt_hash(
    ...
    let result_use_summary_manifest_approval_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_hash(receipt);
    if result_use_summary_manifest_approval_hash == 0
        || receipt.result_use_summary_manifest_approval_hash
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionReceipt,
) -> u64 {
    if receipt.retrieval_result_use_summary_manifest_approval_admission_version == 0
    ...
    let result_use_summary_manifest_approval_admission_status_code =
        match receipt.result_use_summary_manifest_approval_admission_status {
            "result_use_summary_manifest_approval_admitted" => 1,
            "result_use_summary_manifest_approval_not_admitted" => 2,
            _ => 0,
        };
    let not_admitted_reason_code = match receipt.not_admitted_reason {
        "none" => 1,
        "summary_manifest_not_approved" => 2,
        "summary_manifest_not_ready_for_use" => 3,
        "summary_manifest_not_admitted" => 4,
        "missing_external_result_evidence" => 5,
        "retrieval_read_attempted" => 6,
        "retrieval_write_attempted" => 7,
        "retrieval_query_executed" => 8,
        "runtime_result_approval_attempted" => 9,
        "policy_promotion_attempted" => 10,
        "student_training_attempted" => 11,
        "no_policy_reuse_examples" => 12,
        _ => 0,
    };
    if result_use_summary_manifest_approval_admission_status_code == 0
        || not_admitted_reason_code == 0
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_receipt_hash(
    ...
    let result_use_summary_manifest_approval_admission_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_hash(
            receipt,
        );
    if result_use_summary_manifest_approval_admission_hash == 0
        || receipt.result_use_summary_manifest_approval_admission_hash
            != result_use_summary_manifest_approval_admission_hash
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionReceipt,
) -> u64 {
    if receipt.retrieval_result_use_summary_manifest_approval_admission_consumption_version == 0
    ...
    let status_code =
        match receipt.result_use_summary_manifest_approval_admission_consumption_status {
            "result_use_summary_manifest_approval_admission_consumed" => 1,
            "result_use_summary_manifest_approval_admission_not_consumed" => 2,
            _ => 0,
        };
    let not_consumed_reason_code = match receipt.not_consumed_reason {
        "none" => 1,
        "summary_manifest_approval_admission_not_admitted" => 2,
        "summary_manifest_not_approved" => 3,
        "summary_manifest_not_ready_for_use" => 4,
        "summary_manifest_not_admitted" => 5,
        "missing_external_result_evidence" => 6,
        "retrieval_read_attempted" => 7,
        "retrieval_write_attempted" => 8,
        "retrieval_query_executed" => 9,
        "runtime_result_approval_attempted" => 10,
        "policy_promotion_attempted" => 11,
        "batch_execution_attempted" => 12,
        "student_training_attempted" => 13,
        "no_policy_reuse_examples" => 14,
        _ => 0,
    };
    if status_code == 0 || not_consumed_reason_code == 0 {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_receipt_hash(
    ...
    let result_use_summary_manifest_approval_admission_consumption_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_hash(
            receipt,
        );
    if result_use_summary_manifest_approval_admission_consumption_hash == 0
        || receipt.result_use_summary_manifest_approval_admission_consumption_hash
            != result_use_summary_manifest_approval_admission_consumption_hash
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningAdmissionReceipt,
) -> u64 {
    if receipt.retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_version == 0
    ...
    let status_code = match receipt.retrieval_example_learning_admission_status {
        "retrieval_example_learning_admitted" => 1,
        "retrieval_example_learning_not_admitted" => 2,
        _ => 0,
    };
    let not_admitted_reason_code = match receipt.not_admitted_reason {
        "none" => 1,
        "retrieval_example_learning_not_eligible" => 2,
        "approval_admission_consumption_not_consumed" => 3,
        "summary_manifest_approval_admission_not_admitted" => 4,
        "summary_manifest_not_approved" => 5,
        "summary_manifest_not_ready_for_use" => 6,
        "summary_manifest_not_admitted" => 7,
        "missing_external_result_evidence" => 8,
        "retrieval_read_attempted" => 9,
        "retrieval_write_attempted" => 10,
        "retrieval_query_executed" => 11,
        "runtime_result_approval_attempted" => 12,
        "policy_promotion_attempted" => 13,
        "batch_execution_attempted" => 14,
        "student_training_attempted" => 15,
        "no_policy_reuse_examples" => 16,
        _ => 0,
    };
    if status_code == 0 || not_admitted_reason_code == 0 {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_receipt_hash(
    ...
    let retrieval_example_learning_admission_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_admission_hash(
            receipt,
        );
    if retrieval_example_learning_admission_hash == 0
        || receipt.retrieval_example_learning_admission_hash
            != retrieval_example_learning_admission_hash
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningMaterializationPlanReceipt,
) -> u64 {
    if receipt.retrieval_example_learning_materialization_plan_version == 0
    ...
    let status_code = match receipt.retrieval_example_materialization_plan_status {
        "retrieval_example_materialization_plan_ready" => 1,
        "retrieval_example_materialization_plan_not_ready" => 2,
        _ => 0,
    };
    let not_ready_reason_code = match receipt.not_ready_reason {
        "none" => 1,
        "retrieval_example_learning_not_admitted" => 2,
        "retrieval_example_learning_not_eligible" => 3,
        "approval_admission_consumption_not_consumed" => 4,
        "summary_manifest_approval_admission_not_admitted" => 5,
        "summary_manifest_not_approved" => 6,
        "summary_manifest_not_ready_for_use" => 7,
        "summary_manifest_not_admitted" => 8,
        "missing_external_result_evidence" => 9,
        "retrieval_read_attempted" => 10,
        "retrieval_write_attempted" => 11,
        "retrieval_query_executed" => 12,
        "runtime_result_approval_attempted" => 13,
        "policy_promotion_attempted" => 14,
        "batch_execution_attempted" => 15,
        "student_training_attempted" => 16,
        "no_policy_reuse_examples" => 17,
        _ => 0,
    };
    if status_code == 0 || not_ready_reason_code == 0 {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_receipt_hash(
    ...
    let retrieval_example_materialization_plan_hash =
        policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_materialization_plan_hash(
            receipt,
        );
    if retrieval_example_materialization_plan_hash == 0
        || receipt.retrieval_example_materialization_plan_hash
            != retrieval_example_materialization_plan_hash
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_admission_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageAdmissionReceipt,
) -> u64 {
    if receipt.retrieval_example_learning_storage_admission_version == 0
    ...
    let status_code = match receipt.retrieval_example_storage_admission_status {
        "retrieval_example_storage_admitted" => 1,
        "retrieval_example_storage_not_admitted" => 2,
        _ => 0,
    };
    let reason_code = match receipt.not_admitted_reason {
        "none" => 1,
        "retrieval_example_materialization_plan_not_ready" => 2,
        "retrieval_example_learning_not_admitted" => 3,
        "retrieval_example_learning_not_eligible" => 4,
        "approval_admission_consumption_not_consumed" => 5,
        "summary_manifest_approval_admission_not_admitted" => 6,
        "summary_manifest_not_approved" => 7,
        "summary_manifest_not_ready_for_use" => 8,
        "summary_manifest_not_admitted" => 9,
        "missing_external_result_evidence" => 10,
        "retrieval_read_attempted" => 11,
        "retrieval_write_attempted" => 12,
        "retrieval_query_executed" => 13,
        "runtime_result_approval_attempted" => 14,
        "policy_promotion_attempted" => 15,
        "batch_execution_attempted" => 16,
        "student_training_attempted" => 17,
        "no_policy_reuse_examples" => 18,
        _ => 0,
    };
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWritePreflightReceipt,
) -> u64 {
    if receipt.retrieval_example_learning_storage_write_preflight_version == 0
        || receipt.source_retrieval_example_storage_commit_intent_hash == 0
        || receipt.source_retrieval_example_materialization_plan_hash == 0
        || receipt.source_retrieval_example_learning_admission_hash == 0
        || receipt.source_retrieval_example_learning_eligibility_hash == 0
        || receipt.source_retrieval_result_use_summary_manifest_approval_admission_consumption_hash
    ...
    let status_code = match receipt.retrieval_example_storage_write_preflight_status {
        "retrieval_example_storage_write_preflight_ready" => 1,
        "retrieval_example_storage_write_preflight_not_ready" => 2,
        _ => 0,
    };
    let reason_code = match receipt.not_ready_reason {
        "none" => 1,
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_preflight_receipt_hash(
    ...
    if preflight_hash == 0
        || receipt.retrieval_example_storage_write_preflight_hash != preflight_hash
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteApprovalReceipt,
) -> u64 {
    if receipt.retrieval_example_learning_storage_write_approval_version == 0
        || receipt.source_retrieval_example_storage_write_preflight_hash == 0
        || receipt.source_retrieval_example_storage_commit_intent_hash == 0
        || receipt.source_retrieval_example_materialization_plan_hash == 0
        || receipt.source_retrieval_example_learning_admission_hash == 0
        || receipt.source_retrieval_example_learning_eligibility_hash == 0
    ...
    let status_code = match receipt.retrieval_example_storage_write_approval_status {
        "retrieval_example_storage_write_approved" => 1,
        "retrieval_example_storage_write_not_approved" => 2,
        _ => 0,
    };
    let reason_code = match receipt.not_approved_reason {
        "none" => 1,
        "retrieval_example_storage_write_preflight_not_ready" => 2,
        _ => 0,
    };
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_approval_receipt_hash(
    ...
    if approval_hash == 0 || receipt.retrieval_example_storage_write_approval_hash != approval_hash
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteAdmissionReceipt,
) -> u64 {
    if receipt.retrieval_example_learning_storage_write_admission_version == 0
        || receipt.source_retrieval_example_storage_write_approval_hash == 0
        || receipt.source_retrieval_example_storage_write_preflight_hash == 0
        || receipt.source_retrieval_example_storage_commit_intent_hash == 0
        || receipt.source_retrieval_example_materialization_plan_hash == 0
        || receipt.source_retrieval_example_learning_admission_hash == 0
    ...
    let status_code = match receipt.retrieval_example_storage_write_admission_status {
        "retrieval_example_storage_write_admitted" => 1,
        "retrieval_example_storage_write_not_admitted" => 2,
        _ => 0,
    };
    let reason_code = match receipt.not_admitted_reason {
        "none" => 1,
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_admission_receipt_hash(
    ...
    if admission_hash == 0
        || receipt.retrieval_example_storage_write_admission_hash != admission_hash
    {
        return 0;
    }
...
fn policy_reuse_evidence_retrieval_result_use_summary_manifest_approval_admission_consumption_learning_storage_write_commit_intent_hash(
    receipt: &PolicyReuseEvidenceRetrievalResultUseSummaryManifestApprovalAdmissionConsumptionLearningStorageWriteCommitIntentReceipt,
) -> u64 {
    if receipt.retrieval_example_learning_storage_write_commit_intent_version == 0
        || receipt.source_retrieval_example_storage_write_admission_hash == 0
        || receipt.source_retrieval_example_storage_write_approval_hash == 0
        || receipt.source_retrieval_example_storage_write_preflight_hash == 0
        || receipt.source_retrieval_example_storage_commit_intent_hash == 0
        || receipt.source_retrieval_example_materialization_plan_hash == 0
    ...
    let status_code = match receipt.retrieval_example_storage_write_commit_intent_status {
        "retrieval_example_storage_write_commit_intent_ready" => 1,
        "retrieval_example_storage_write_commit_intent_not_ready" => 2,
        _ => 0,
    };
    let reason_code = match receipt.not_ready_reason {
        "none" => 1,
    ...
    h = h.wrapping_mul(0x100000001b3)
        ^ receipt.source_retrieval_example_storage_write_admission_hash;
    h = h.wrapping_mul(0x100000001b3)
        ^ receipt.source_retrieval_example_storage_write_approval_hash;
    h = h.wrapping_mul(0x100000001b3)
        ^ receipt.source_retrieval_example_storage_write_preflight_hash;
...
mod tests {
    ...
    #[test]
    fn validation_harness_learning_data_admission_builder_preserves_smoke_and_regression_boundaries(
    ) {
        let smoke_candidate = policy_reuse_evidence_learning_candidate_smoke_receipt();
        let smoke_evaluator = policy_reuse_evidence_external_evaluator_result_smoke_receipt();
        let smoke_admission = policy_reuse_evidence_learning_data_admission_smoke_receipt();

        assert!(smoke_admission.is_valid());
        assert!(smoke_admission.passed());
        assert!(smoke_admission.learning_data_admitted);
        assert_eq!(
            smoke_admission.record_type,
            POLICY_REUSE_EVIDENCE_LEARNING_DATA_ADMISSION_SMOKE_STEP
        );
        assert_eq!(
            smoke_admission.source_learning_candidate_hash,
            smoke_candidate.receipt_hash
        );
        assert_eq!(
            smoke_admission.source_external_evaluator_result_hash,
            smoke_evaluator.receipt_hash
        );
        assert!(smoke_admission.learning_candidate_ready);
        assert!(smoke_admission.evaluator_result_passed);
        assert!(!smoke_admission.policy_promotion_performed);
        assert!(!smoke_admission.retrieval_write_performed);
        assert!(!smoke_admission.student_training_performed);
        assert_eq!(smoke_admission.admission_status, "admitted");
        assert_eq!(smoke_admission.not_admitted_reason, "none");
        assert_ne!(smoke_admission.admission_hash, 0);
        assert_ne!(smoke_admission.receipt_hash, 0);
        assert_eq!(
            smoke_admission.admission_hash,
            policy_reuse_evidence_learning_data_admission_hash(&smoke_admission)
        );
        assert_eq!(
            smoke_admission.receipt_hash,
            policy_reuse_evidence_learning_data_admission_receipt_hash(&smoke_admission)
        );
        ...
        assert!(regression_admission.is_valid());
        assert!(!regression_admission.passed());
        assert!(!regression_admission.learning_data_admitted);
        assert_eq!(
            regression_admission.record_type,
            POLICY_REUSE_EVIDENCE_LEARNING_DATA_ADMISSION_REGRESSION_SMOKE_STEP
        );
        assert_eq!(
            regression_admission.source_learning_candidate_hash,
            regression_candidate.receipt_hash
        );
        assert_eq!(
            regression_admission.source_external_evaluator_result_hash,
            regression_evaluator.receipt_hash
        );
        assert!(!regression_admission.learning_candidate_ready);
        assert!(!regression_admission.evaluator_result_passed);
        assert!(!regression_admission.policy_promotion_performed);
        assert!(!regression_admission.retrieval_write_performed);
        assert!(!regression_admission.student_training_performed);
        assert_eq!(regression_admission.admission_status, "not_admitted");
        assert_eq!(
            regression_admission.not_admitted_reason,
            "candidate_not_ready"
        );
        assert_ne!(regression_admission.admission_hash, 0);
        assert_ne!(regression_admission.receipt_hash, 0);
        assert_eq!(
            regression_admission.admission_hash,
            policy_reuse_evidence_learning_data_admission_hash(&regression_admission)
        );
        assert_eq!(
            regression_admission.receipt_hash,
            policy_reuse_evidence_learning_data_admission_receipt_hash(&regression_admission)
        );
