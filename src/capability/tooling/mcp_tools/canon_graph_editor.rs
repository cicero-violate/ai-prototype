...
pub fn run_plan_patch(args: &Value, workspace: &WorkspaceView) -> Value {
    crate::capability::tooling::graph_editor::plan_patch_tool(args, workspace)
}

pub fn run_plan_cfg(args: &Value, workspace: &WorkspaceView) -> Value {
    crate::capability::tooling::graph_editor::plan_cfg_tool(args, workspace)
}

pub fn run_apply_ops(args: &Value, workspace: &WorkspaceView) -> Value {
    crate::capability::tooling::graph_editor::apply_ops_tool(args, workspace)
}

pub fn run_verify_cfg_delta(args: &Value, workspace: &WorkspaceView) -> Value {
    crate::capability::tooling::graph_editor::verify_cfg_delta_tool(args, workspace)
}

pub fn run_auto_refactor_cfg(args: &Value, workspace: &WorkspaceView) -> Value {
    crate::capability::tooling::graph_editor::auto_refactor_cfg_tool(args, workspace)
}
