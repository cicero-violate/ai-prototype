//! `canon_spawn_agent` action tool argument contract.
//!
//! The capability layer owns the action tool schema and argument parsing. The
//! supervisor host performs actual worker spawning through `ActionHost`.
