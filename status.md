...
- First incomplete Active Priorities item after implementation step 1 on 2026-05-11: `src/domain/risk.rs` `RiskEnvelopeViolation` and `check_risk_envelope(...)` item 18.
