...
- First incomplete Active Priorities item after implementation step 4 on 2026-05-10: `src/domain/scoring.rs` unit test `verdict_simulate_trading_thresholds` item 16.
