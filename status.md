...
- Active Priorities items 25 through 84 are complete in the working tree. The next executable item is item 85, the scoped `run_llm_gate_phase(...)` extraction in `src/agent/cycle.rs::AgentCycle::run(...)`.
