...
- Active Priorities items 25 through 85 are complete in the working tree. Item 85 extracted `run_llm_gate_phase(...)` in `src/agent/cycle.rs` and passed targeted, formatter, and full-suite validation.
