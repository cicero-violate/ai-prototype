...
- First incomplete Active Priorities item after implementation step 2 on 2026-05-11: `src/domain/risk.rs` unit test `risk_blocks_live_trading` item 19.
