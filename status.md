...
- Active Priorities items 25 through 87 are complete in the working tree. Item 87 extracted `submit_openai_process_receipt_batch(...)` in `examples/openai_tool_loop_trace.rs` and passed example compile, formatter, and full-suite validation.
