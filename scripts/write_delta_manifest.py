...
def write_manifest(path: Path, r: dict[str, Any]) -> None:
    lines = [
        ...
        *[f"- {name}" for name in r["changed_files"]],
        ...
        f"- runtime_archive_inspection_status: {r['runtime_archive_inspection_status']}",
        f"- runtime_archive_download_index_files: {r['runtime_archive_download_index_files']}",
        f"- runtime_archive_prior_state_files: {r['runtime_archive_prior_state_files']}",
        f"- runtime_archive_conversation_ledger_files: {r['runtime_archive_conversation_ledger_files']}",
        f"- runtime_archive_delta_receipt_files: {r['runtime_archive_delta_receipt_files']}",
        f"- runtime_archive_audit_files: {r['runtime_archive_audit_files']}",
        f"- runtime_archive_current_run_summary_present: {r['runtime_archive_current_run_summary_present']}",
        f"- runtime_archive_runtime_manifest_present: {r['runtime_archive_runtime_manifest_present']}",
