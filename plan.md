...
102. [ ] `src/agent/cycle.rs` test `submit_evidence_hash_input_helper_preserves_domain_vectors`: add focused regression coverage for the shared submit-evidence hash-input helper.
