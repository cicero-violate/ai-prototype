...
120. [ ] `src/agent/cycle.rs` test `submit_evidence_hash_wrapper_helper_preserves_domain_inputs`: add focused regression coverage for the new wrapper-delegation boundary.
