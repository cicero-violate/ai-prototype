...
158. [ ] `src/validation_harness.rs` test `validation_harness_cost_catalog_builder_preserves_complete_and_incomplete_boundaries`: add focused regression coverage for the shared cost-catalog smoke receipt builder introduced by item 157.
