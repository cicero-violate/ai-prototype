...
138. [ ] `src/capability/judgment/record.rs` test `policy_reuse_hash_fold_wrappers_preserve_distinct_domains`: add focused regression coverage for the shared judgment/policy-reuse fold helper boundary.
