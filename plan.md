...
34. [ ] `src/capability/judgment/record.rs`: extract private `PolicyReuseCostCatalogReceipt` catalog-completion and source-hash helper predicates for `from_source_hashes(...)` and `is_valid(...)`.
