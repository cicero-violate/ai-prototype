...
144. [ ] `src/capability/policy/store.rs` test `policy_proof_hash_helper_preserves_receipt_and_verifier_boundaries`: add focused regression coverage for the shared policy proof hash-fold helper boundary.
