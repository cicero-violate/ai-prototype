...
95. [ ] `src/capability/llm/openai.rs`: route `encode_openai_llm_effect_receipt_ndjson(...)` and `encode_openai_judgment_proof_event_ndjson(...)` through one private numeric-field NDJSON array formatting helper.
