...
150. [ ] `src/capability/llm/openai.rs` test `openai_effect_and_proof_hash_fold_helper_preserves_distinct_domains`: add focused regression coverage for the shared OpenAI LLM hash-fold boundary.
