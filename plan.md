...
123. [ ] `src/capability/llm/ollama.rs` test `ollama_ndjson_loader_helper_preserves_checked_unchecked_boundaries`: add focused regression coverage for the shared loader dispatch boundary.
