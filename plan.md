...
113. [ ] `src/agent/cycle.rs`: add unit test `dispatch_observed_phase_submits_invariant_without_llm`.
...
114. [ ] `src/agent/cycle.rs`: add unit test `dispatch_observed_phase_stops_when_llm_phase_requests_review`.
...
115. [ ] `SCORE_REPORT.md`: refresh graph-derived structural evidence after items 112-114 land, then review whether `score.md` rationale should change without raising project-level scores absent capability evidence.
   - Scope: `SCORE_REPORT.md`, `score.md`, `status.md`, and `plan.md` only.
