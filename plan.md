...
46. [ ] `src/api/transport.rs`: route `ApiTransportLedger::has_conflicting_request(...)` through the same receipt lookup boundary as `ApiTransportLedger::contains_request_id(...)`.
