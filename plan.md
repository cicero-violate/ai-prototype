...
47. [ ] `tests/api_transport_contract.rs` test `transport_ledger_conflicting_request_detection_is_payload_hash_scoped`: strengthen conflict-boundary regression coverage.
