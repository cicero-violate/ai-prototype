...
131. [ ] `src/capability/planning/record.rs`: route `objective_hash(...)`, `lineage_hash(...)`, and `plan_payload_hash(...)` through one private ordered planning hash-fold helper while preserving distinct hash domains.
