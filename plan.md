...
1. [ ] `src/agent/cycle.rs`: replace duplicate command/envelope/contract hash wrapper mechanics with a typed local hash-domain descriptor while preserving public/private helper names and exact hash outputs.
