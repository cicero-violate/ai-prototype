...
117. [ ] `src/capability/judgment/record.rs` test `policy_reuse_receipt_hash_helper_preserves_current_and_trend_boundaries`: add focused regression coverage for the shared policy-reuse receipt hash helper boundary.
