...
108. [ ] `src/agent/worker_client.rs` test `worker_client_constructor_helper_preserves_timeout_boundaries`: add focused regression coverage for the shared worker-client constructor helper.
