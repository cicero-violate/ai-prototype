...
114. [ ] `src/capability/judgment/record.rs` test `policy_reuse_content_hash_helpers_preserve_catalog_and_savings_boundaries`: add focused regression coverage for the shared policy-reuse content hash helper.
