...
157. [ ] `src/validation_harness.rs`: route `policy_reuse_cost_catalog_smoke_receipt(...)` and `policy_reuse_cost_catalog_incomplete_smoke_receipt(...)` through one private cost-catalog smoke receipt builder while preserving complete and incomplete catalog semantics.
