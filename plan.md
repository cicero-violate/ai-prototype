...
141. [ ] `src/api/server.rs` test `api_submission_token_extractors_preserve_gate_evidence_and_error_boundaries`: add focused regression coverage for the shared gate/evidence extraction helper.
