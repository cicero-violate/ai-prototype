...
37. [ ] `src/capability/learning/promote.rs`: extract private policy-promotion entry builder and checked in-memory append helper for `PolicyStore::promote(...)` and `PolicyStore::promote_feedback(...)`.
