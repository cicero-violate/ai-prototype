...
35. [ ] `src/capability/judgment/record.rs` test `policy_reuse_cost_catalog_helper_boundary_rejects_source_and_completion_tampering`: add direct regression coverage for the shared catalog helper boundary.
   - Scope: `src/capability/judgment/record.rs` test module only.
