...
107. [ ] `src/agent/worker_client.rs`: route `WorkerClient::new(...)` and `WorkerClient::new_with_timeout(...)` through one private constructor helper while preserving default and custom timeout semantics.
