...
96. [ ] `src/capability/llm/openai.rs` test `openai_ndjson_encoders_preserve_record_layouts`: add focused regression coverage for the shared OpenAI NDJSON encoder helper.
