...
132. [ ] `src/capability/planning/record.rs` test `planning_hash_fold_helper_preserves_objective_lineage_and_payload_boundaries`: add focused regression coverage for the shared planning hash-fold boundary.
