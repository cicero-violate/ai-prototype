...
105. [ ] `src/api/transport.rs` test `api_transport_ledger_lookup_helper_preserves_frame_and_request_boundaries`: add focused regression coverage for the shared transport-ledger receipt lookup helper.
