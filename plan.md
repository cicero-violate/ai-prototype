...
153. [ ] `src/capability/llm/openai.rs` test `openai_ndjson_loader_dispatch_preserves_record_boundaries`: add focused regression coverage for the shared OpenAI NDJSON loader dispatch helper.
