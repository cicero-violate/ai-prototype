...
147. [ ] `src/capability/tooling/record/receipt.rs` test `tooling_effect_receipt_hash_fold_helper_preserves_artifact_and_process_boundaries`: add focused regression coverage for the shared tooling effect receipt hash-fold boundary.
