...
156. [ ] `src/validation_harness.rs` test `validation_harness_capacity_trend_builder_preserves_smoke_boundaries`: add focused regression coverage for the shared capacity-trend smoke receipt builder.
